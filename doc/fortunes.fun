...
Run a command with unspecified long sequence of 'a', a developer will be summoned and do the analysis for you.
...
DOOM all the things!
Rizin is the vegan pineapple pizza of reverse engineering tools.
