...
static RzBinReloc *reloc_convert_aarch64(ELFOBJ *bin, RzBinElfReloc *rel, ut64 GOT) {
	...
	case R_AARCH64_P32_ABS16: ADD(16, 0, "R_AARCH64_P32_ABS16");
	case R_AARCH64_PREL64: ADD(64, -P, "R_AARCH64_PREL64");
	case R_AARCH64_PREL32: ADD(32, -P, "R_AARCH64_PREL32");
	case R_AARCH64_P32_PREL32: ADD(32, -P, "R_AARCH64_P32_PREL32");
	case R_AARCH64_PREL16: ADD(16, -P, "R_AARCH64_PREL16");
	case R_AARCH64_P32_PREL16: ADD(16, -P, "R_AARCH64_P32_PREL16");
	case R_AARCH64_PLT32: ADD(32, -P, "R_AARCH64_PLT32");
	case R_AARCH64_P32_PLT32: ADD(32, -P, "R_AARCH64_P32_PLT32");
	case R_AARCH64_MOVW_UABS_G0: ADD(64, 0, "R_AARCH64_MOVW_UABS_G0");
	case R_AARCH64_P32_MOVW_UABS_G0: ADD(32, 0, "R_AARCH64_P32_MOVW_UABS_G0");
	case R_AARCH64_MOVW_UABS_G0_NC: ADD(64, 0, "R_AARCH64_MOVW_UABS_G0_NC");
	case R_AARCH64_P32_MOVW_UABS_G0_NC: ADD(32, 0, "R_AARCH64_P32_MOVW_UABS_G0_NC");
	case R_AARCH64_MOVW_UABS_G1: ADD(64, 0, "R_AARCH64_MOVW_UABS_G1");
	case R_AARCH64_P32_MOVW_UABS_G1: ADD(32, 0, "R_AARCH64_P32_MOVW_UABS_G1");
	case R_AARCH64_MOVW_UABS_G1_NC: ADD(64, 0, "R_AARCH64_MOVW_UABS_G1_NC");
	case R_AARCH64_MOVW_UABS_G2: ADD(64, 0, "R_AARCH64_MOVW_UABS_G2");
	case R_AARCH64_MOVW_UABS_G2_NC: ADD(64, 0, "R_AARCH64_MOVW_UABS_G2_NC");
	case R_AARCH64_MOVW_UABS_G3: ADD(64, 0, "R_AARCH64_MOVW_UABS_G3");
	case R_AARCH64_MOVW_SABS_G0: ADD(64, 0, "R_AARCH64_MOVW_SABS_G0");
	case R_AARCH64_P32_MOVW_SABS_G0: ADD(32, 0, "R_AARCH64_P32_MOVW_SABS_G0");
	case R_AARCH64_MOVW_SABS_G1: ADD(64, 0, "R_AARCH64_MOVW_SABS_G1");
	case R_AARCH64_MOVW_SABS_G2: ADD(64, 0, "R_AARCH64_MOVW_SABS_G2");
	case R_AARCH64_LD_PREL_LO19: ADD(64, -P, "R_AARCH64_LD_PREL_LO19");
	case R_AARCH64_P32_LD_PREL_LO19: ADD(32, -P, "R_AARCH64_P32_LD_PREL_LO19");
	case R_AARCH64_ADR_PREL_LO21: ADD(64, -P, "R_AARCH64_ADR_PREL_LO21");
	case R_AARCH64_P32_ADR_PREL_LO21: ADD(32, -P, "R_AARCH64_P32_ADR_PREL_LO21");
	...
	case R_AARCH64_ADD_ABS_LO12_NC: ADD(64, 0, "R_AARCH64_ADD_ABS_LO12_NC");
	case R_AARCH64_P32_ADD_ABS_LO12_NC: ADD(32, 0, "R_AARCH64_P32_ADD_ABS_LO12_NC");
	case R_AARCH64_LDST8_ABS_LO12_NC: ADD(64, 0, "R_AARCH64_LDST8_ABS_LO12_NC");
	case R_AARCH64_P32_LDST8_ABS_LO12_NC: ADD(32, 0, "R_AARCH64_P32_LDST8_ABS_LO12_NC");
	case R_AARCH64_LDST16_ABS_LO12_NC: ADD(64, 0, "R_AARCH64_LDST16_ABS_LO12_NC");
	case R_AARCH64_P32_LDST16_ABS_LO12_NC: ADD(32, 0, "R_AARCH64_P32_LDST16_ABS_LO12_NC");
	case R_AARCH64_LDST32_ABS_LO12_NC: ADD(64, 0, "R_AARCH64_LDST32_ABS_LO12_NC");
	case R_AARCH64_P32_LDST32_ABS_LO12_NC: ADD(32, 0, "R_AARCH64_P32_LDST32_ABS_LO12_NC");
	case R_AARCH64_LDST64_ABS_LO12_NC: ADD(64, 0, "R_AARCH64_LDST64_ABS_LO12_NC");
	case R_AARCH64_P32_LDST64_ABS_LO12_NC: ADD(32, 0, "R_AARCH64_P32_LDST64_ABS_LO12_NC");
	case R_AARCH64_LDST128_ABS_LO12_NC: ADD(64, 0, "R_AARCH64_LDST128_ABS_LO12_NC");
	case R_AARCH64_P32_LDST128_ABS_LO12_NC: ADD(32, 0, "R_AARCH64_P32_LDST128_ABS_LO12_NC");
	case R_AARCH64_TSTBR14: ADD(64, -P, "R_AARCH64_TSTBR14");
	case R_AARCH64_P32_TSTBR14: ADD(32, -P, "R_AARCH64_P32_TSTBR14");
	case R_AARCH64_CONDBR19: ADD(64, -P, "R_AARCH64_CONDBR19");
	case R_AARCH64_P32_CONDBR19: ADD(32, -P, "R_AARCH64_P32_CONDBR19");
	case R_AARCH64_JUMP26: ADD(64, -P, "R_AARCH64_JUMP26");
	case R_AARCH64_P32_JUMP26: ADD(32, -P, "R_AARCH64_P32_JUMP26");
	case R_AARCH64_CALL26: ADD(64, -P, "R_AARCH64_CALL26");
	case R_AARCH64_P32_CALL26: ADD(32, -P, "R_AARCH64_P32_CALL26");
	case R_AARCH64_MOVW_PREL_G0: ADD(64, -P, "R_AARCH64_MOVW_PREL_G0");
	case R_AARCH64_P32_MOVW_PREL_G0: ADD(32, -P, "R_AARCH64_P32_MOVW_PREL_G0");
	case R_AARCH64_MOVW_PREL_G0_NC: ADD(64, -P, "R_AARCH64_MOVW_PREL_G0_NC");
	case R_AARCH64_P32_MOVW_PREL_G0_NC: ADD(32, -P, "R_AARCH64_P32_MOVW_PREL_G0_NC");
	case R_AARCH64_MOVW_PREL_G1: ADD(64, -P, "R_AARCH64_MOVW_PREL_G1");
	case R_AARCH64_P32_MOVW_PREL_G1: ADD(32, -P, "R_AARCH64_P32_MOVW_PREL_G1");
	case R_AARCH64_MOVW_PREL_G1_NC: ADD(64, -P, "R_AARCH64_MOVW_PREL_G1_NC");
	case R_AARCH64_MOVW_PREL_G2: ADD(64, -P, "R_AARCH64_MOVW_PREL_G2");
	case R_AARCH64_MOVW_PREL_G2_NC: ADD(64, -P, "R_AARCH64_MOVW_PREL_G2_NC");
	case R_AARCH64_MOVW_PREL_G3: ADD(64, -P, "R_AARCH64_MOVW_PREL_G3");
>>>>>>> 1328b48057 (add new relocs and conversions)
	...
	case R_AARCH64_GOTREL64: ADD(64, -GOT, "R_AARCH64_GOTREL64");
	case R_AARCH64_GOTREL32: ADD(32, -GOT, "R_AARCH64_GOTREL32");
	case R_AARCH64_GOT_LD_PREL19: UNHANDL("R_AARCH64_GOT_LD_PREL19");
	case R_AARCH64_P32_GOT_LD_PREL19: UNHANDL("R_AARCH64_P32_GOT_LD_PREL19");
	...
	case R_AARCH64_P32_TLSLE_LDST128_TPREL_LO12_NC: ADD(32, 0, "R_AARCH64_P32_TLSLE_LDST128_TPREL_LO12_NC");
	...
	case R_AARCH64_GLOB_DAT: ADD(64, 0, "R_AARCH64_GLOB_DAT");
	case R_AARCH64_P32_GLOB_DAT: ADD(32, 0, "R_AARCH64_P32_GLOB_DAT");
	case R_AARCH64_JUMP_SLOT: ADD(64, 0, "R_AARCH64_JUMP_SLOT");
	case R_AARCH64_P32_JUMP_SLOT: ADD(32, 0, "R_AARCH64_P32_JUMP_SLOT");
