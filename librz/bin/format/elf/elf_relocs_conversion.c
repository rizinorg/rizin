...
static RzBinReloc *reloc_convert_aarch64(ELFOBJ *bin, RzBinElfReloc *rel, ut64 GOT) {
	...
	case R_AARCH64_GLOB_DAT: ADD(64, 0, "R_AARCH64_GLOB_DAT", R_AARCH64_GLOB_DAT);
	case R_AARCH64_P32_GLOB_DAT: ADD(32, 0, "R_AARCH64_P32_GLOB_DAT", R_AARCH64_GLOB_DAT);
	case R_AARCH64_JUMP_SLOT: ADD(64, 0, "R_AARCH64_JUMP_SLOT", R_AARCH64_GLOB_DAT);
	case R_AARCH64_P32_JUMP_SLOT: ADD(32, 0, "R_AARCH64_P32_JUMP_SLOT", R_AARCH64_GLOB_DAT);
