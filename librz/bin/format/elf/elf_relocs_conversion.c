...
static RzBinReloc *reloc_convert_intel_80386(ELFOBJ *bin, RzBinElfReloc *rel, ut64 GOT) {
	...
	case R_386_PLT32: ADD(32, -P, "R_386_PLT32", RZ_RELOC_BASE_PLT_SYMBOL);
	...
	case R_386_TLS_TPOFF: ADD(32, 0, "R_386_TLS_TPOFF", RZ_RELOC_BASE_UNKNOWN);
	...
	case R_386_TLS_DTPMOD32: ADD(32, 0, "R_386_TLS_DTPMOD32", RZ_RELOC_BASE_UNKNOWN);
	case R_386_TLS_DTPOFF32: ADD(32, 0, "R_386_TLS_DTPOFF32", RZ_RELOC_BASE_UNKNOWN);
	...
	case R_386_GOT32X: ADD(32, 0, "R_386_GOT32X", RZ_RELOC_BASE_GOT_SYMBOL);
...
static RzBinReloc *reloc_convert_amd64(ELFOBJ *bin, RzBinElfReloc *rel, ut64 GOT) {
	...
	case R_X86_64_DTPMOD64: ADD(64, 0, "R_X86_64_DTPMOD64", RZ_RELOC_BASE_UNKNOWN);
	case R_X86_64_DTPOFF64: ADD(64, 0, "R_X86_64_DTPOFF64", RZ_RELOC_BASE_UNKNOWN);
	case R_X86_64_TPOFF64: ADD(64, 0, "R_X86_64_TPOFF64", RZ_RELOC_BASE_UNKNOWN);
...
static RzBinReloc *reloc_convert_aarch64(ELFOBJ *bin, RzBinElfReloc *rel, ut64 GOT) {
	...
	case R_AARCH64_TSTBR14: ADD(32, 0, "R_AARCH64_TSTBR14", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_CONDBR19: ADD(32, 0, "R_AARCH64_CONDBR19", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_LDST16_ABS_LO12_NC: ADD(32, 0, " R_AARCH64_LDST16_ABS_LO12_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_LDST32_ABS_LO12_NC: ADD(32, 0, " R_AARCH64_LDST32_ABS_LO12_NC", RZ_RELOC_BASE_SYMBOL);
	...
	case R_AARCH64_LDST128_ABS_LO12_NC: ADD(32, 0, "R_AARCH64_LDST128_ABS_LO12_NC", RZ_RELOC_BASE_SYMBOL);
