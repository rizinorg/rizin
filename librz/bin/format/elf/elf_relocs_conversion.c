...
static RzBinReloc *reloc_convert_amd64(ELFOBJ *bin, RzBinElfReloc *rel, ut64 GOT) {
	...
	case R_X86_64_PC64: ADD(64, -P, "R_X86_64_PC64");
	case R_X86_64_GOTOFF64: ADD(64, -GOT, "R_X86_64_GOTOFF64");
	case R_X86_64_GOTPC32: ADD(32, -P, "R_X86_64_GOTPC32");
	case R_X86_64_GOT64: ADD(64, 0,"R_X86_64_GOT64");
	case R_X86_64_GOTPCREL64: ADD(64, GOT -P, "R_X86_64_GOTPCREL64");
	case R_X86_64_GOTPC64: ADD(64, GOT - P, "R_X86_64_GOTPC64");
	case R_X86_64_GOTPLT64: UNHANDL("R_X86_64_GOTPLT64");
	case R_X86_64_PLTOFF64: ADD(64, -GOT, "R_X86_64_PLTOFF64");
	...
	case R_X86_64_RELATIVE64: ADD(64, 0, "R_X86_64_RELATIVE64");
	case R_X86_64_GOTPCRELX: ADD(32, GOT - P, "R_X86_64_GOTPCRELX");
	case R_X86_64_REX_GOTPCRELX: ADD(32, GOT - P, "R_X86_64_REX_GOTPCRELX");
	case R_X86_64_CODE_4_GOTPCRELX: ADD(32, GOT - P, "R_X86_64_CODE_4_GOTPCRELX");
	...
	case R_X86_64_CODE_5_GOTPCRELX: ADD(32, GOT - P, "R_X86_64_CODE_5_GOTPCRELX");
	...
	case R_X86_64_CODE_6_GOTPCRELX: ADD(32, GOT - P, "R_X86_64_CODE_6_GOTPCRELX");
