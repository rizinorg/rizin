...
static RzBinReloc *reloc_convert_arm(ELFOBJ *bin, RzBinElfReloc *rel, ut64 GOT) {
	...
	case R_ARM_THM_CALL: ADD_T(24, T, -P, "R_ARM_THM_CALL", RZ_RELOC_BASE_SYMBOL);
	...
	case R_ARM_THM_ALU_ABS_G1_NC: ADD_T(16, T, 0, "R_ARM_THM_ALU_ABS_G1_NC", RZ_RELOC_BASE_SYMBOL);
	case R_ARM_THM_ALU_ABS_G2_NC: ADD_T(16, 0, T, "R_ARM_THM_ALU_ABS_G2_NC", RZ_RELOC_BASE_SYMBOL);
	case R_ARM_THM_ALU_ABS_G3: ADD_T(16, 0, T, "R_ARM_THM_ALU_ABS_G3", RZ_RELOC_BASE_SYMBOL);
...
static RzBinReloc *reloc_convert_aarch64(ELFOBJ *bin, RzBinElfReloc *rel, ut64 GOT) {
	...
	case R_AARCH64_P32_ABS32: ADD(32, 0, "R_AARCH64_P32_ABS32", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_ABS16: ADD(16, 0, "R_AARCH64_ABS16", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_ABS16: ADD(16, 0, "R_AARCH64_P32_ABS16", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_PREL64: ADD(64, -P, "R_AARCH64_PREL64", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_PREL32: ADD(32, -P, "R_AARCH64_PREL32", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_PREL32: ADD(32, -P, "R_AARCH64_P32_PREL32", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_PREL16: ADD(16, -P, "R_AARCH64_PREL16", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_PREL16: ADD(16, -P, "R_AARCH64_P32_PREL16", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_PLT32: ADD(32, -P, "R_AARCH64_PLT32", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_PLT32: ADD(32, -P, "R_AARCH64_P32_PLT32", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_UABS_G0: ADD(64, 0, "R_AARCH64_MOVW_UABS_G0", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_MOVW_UABS_G0: ADD(32, 0, "R_AARCH64_P32_MOVW_UABS_G0", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_UABS_G0_NC: ADD(64, 0, "R_AARCH64_MOVW_UABS_G0_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_MOVW_UABS_G0_NC: ADD(32, 0, "R_AARCH64_P32_MOVW_UABS_G0_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_UABS_G1: ADD(64, 0, "R_AARCH64_MOVW_UABS_G1", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_MOVW_UABS_G1: ADD(32, 0, "R_AARCH64_P32_MOVW_UABS_G1", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_UABS_G1_NC: ADD(64, 0, "R_AARCH64_MOVW_UABS_G1_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_UABS_G2: ADD(64, 0, "R_AARCH64_MOVW_UABS_G2", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_UABS_G2_NC: ADD(64, 0, "R_AARCH64_MOVW_UABS_G2_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_UABS_G3: ADD(64, 0, "R_AARCH64_MOVW_UABS_G3", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_SABS_G0: ADD(64, 0, "R_AARCH64_MOVW_SABS_G0", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_MOVW_SABS_G0: ADD(32, 0, "R_AARCH64_P32_MOVW_SABS_G0", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_SABS_G1: ADD(64, 0, "R_AARCH64_MOVW_SABS_G1", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_SABS_G2: ADD(64, 0, "R_AARCH64_MOVW_SABS_G2", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_LD_PREL_LO19: ADD(64, -P, "R_AARCH64_LD_PREL_LO19", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_LD_PREL_LO19: ADD(32, -P, "R_AARCH64_P32_LD_PREL_LO19", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_ADR_PREL_LO21: ADD(64, -P, "R_AARCH64_ADR_PREL_LO21", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_ADR_PREL_LO21: ADD(32, -P, "R_AARCH64_P32_ADR_PREL_LO21", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_ADR_PREL_PG_HI21: UNHANDL("R_AARCH64_ADR_PREL_PG_HI21"); // Page(S+A)-Page(P)
	case R_AARCH64_P32_ADR_PREL_PG_HI21: UNHANDL("R_AARCH64_P32_ADR_PREL_PG_HI21"); // Page(S+A)-Page(P)
	case R_AARCH64_ADR_PREL_PG_HI21_NC: UNHANDL("R_AARCH64_ADR_PREL_PG_HI21_NC"); // Page(S+A)-Page(P)
	case R_AARCH64_ADD_ABS_LO12_NC: ADD(64, 0, "R_AARCH64_ADD_ABS_LO12_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_ADD_ABS_LO12_NC: ADD(32, 0, "R_AARCH64_P32_ADD_ABS_LO12_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_LDST8_ABS_LO12_NC: ADD(64, 0, "R_AARCH64_LDST8_ABS_LO12_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_LDST8_ABS_LO12_NC: ADD(32, 0, "R_AARCH64_P32_LDST8_ABS_LO12_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_LDST16_ABS_LO12_NC: ADD(64, 0, "R_AARCH64_LDST16_ABS_LO12_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_LDST16_ABS_LO12_NC: ADD(32, 0, "R_AARCH64_P32_LDST16_ABS_LO12_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_LDST32_ABS_LO12_NC: ADD(64, 0, "R_AARCH64_LDST32_ABS_LO12_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_LDST32_ABS_LO12_NC: ADD(32, 0, "R_AARCH64_P32_LDST32_ABS_LO12_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_LDST64_ABS_LO12_NC: ADD(64, 0, "R_AARCH64_LDST64_ABS_LO12_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_LDST64_ABS_LO12_NC: ADD(32, 0, "R_AARCH64_P32_LDST64_ABS_LO12_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_LDST128_ABS_LO12_NC: ADD(64, 0, "R_AARCH64_LDST128_ABS_LO12_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_LDST128_ABS_LO12_NC: ADD(32, 0, "R_AARCH64_P32_LDST128_ABS_LO12_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_TSTBR14: ADD(64, -P, "R_AARCH64_TSTBR14", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_TSTBR14: ADD(32, -P, "R_AARCH64_P32_TSTBR14", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_CONDBR19: ADD(64, -P, "R_AARCH64_CONDBR19", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_CONDBR19: ADD(32, -P, "R_AARCH64_P32_CONDBR19", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_JUMP26: ADD(64, -P, "R_AARCH64_JUMP26", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_JUMP26: ADD(32, -P, "R_AARCH64_P32_JUMP26", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_CALL26: ADD(64, -P, "R_AARCH64_CALL26", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_CALL26: ADD(32, -P, "R_AARCH64_P32_CALL26", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_PREL_G0: ADD(64, -P, "R_AARCH64_MOVW_PREL_G0", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_MOVW_PREL_G0: ADD(32, -P, "R_AARCH64_P32_MOVW_PREL_G0", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_PREL_G0_NC: ADD(64, -P, "R_AARCH64_MOVW_PREL_G0_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_MOVW_PREL_G0_NC: ADD(32, -P, "R_AARCH64_P32_MOVW_PREL_G0_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_PREL_G1: ADD(64, -P, "R_AARCH64_MOVW_PREL_G1", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_MOVW_PREL_G1: ADD(32, -P, "R_AARCH64_P32_MOVW_PREL_G1", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_PREL_G1_NC: ADD(64, -P, "R_AARCH64_MOVW_PREL_G1_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_PREL_G2: ADD(64, -P, "R_AARCH64_MOVW_PREL_G2", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_PREL_G2_NC: ADD(64, -P, "R_AARCH64_MOVW_PREL_G2_NC", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_PREL_G3: ADD(64, -P, "R_AARCH64_MOVW_PREL_G3", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_MOVW_GOTOFF_G0: UNHANDL("R_AARCH64_MOVW_GOTOFF_G0");
	case R_AARCH64_MOVW_GOTOFF_G0_NC: ADD(32, -GOT, "R_AARCH64_MOVW_GOTOFF_G0_NC", RZ_RELOC_BASE_GOT_SYMBOL);
	case R_AARCH64_MOVW_GOTOFF_G1: ADD(32, -GOT, "R_AARCH64_MOVW_GOTOFF_G1", RZ_RELOC_BASE_GOT_SYMBOL);
	case R_AARCH64_MOVW_GOTOFF_G1_NC: ADD(32, -GOT, "R_AARCH64_MOVW_GOTOFF_G1_NC", RZ_RELOC_BASE_GOT_SYMBOL);
	case R_AARCH64_MOVW_GOTOFF_G2: ADD(32, -GOT, "R_AARCH64_MOVW_GOTOFF_G2", RZ_RELOC_BASE_GOT_SYMBOL);
	case R_AARCH64_MOVW_GOTOFF_G2_NC: ADD(32, -GOT, "R_AARCH64_MOVW_GOTOFF_G2_NC", RZ_RELOC_BASE_GOT_SYMBOL);
	case R_AARCH64_MOVW_GOTOFF_G3: ADD(32, -GOT, "R_AARCH64_MOVW_GOTOFF_G3", RZ_RELOC_BASE_GOT_SYMBOL);
	case R_AARCH64_GOTREL64: ADD(64, -GOT, "R_AARCH64_GOTREL64", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_GOTREL32: ADD(32, -GOT, "R_AARCH64_GOTREL32", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_GOT_LD_PREL19: ADD(32, -P, "R_AARCH64_GOT_LD_PREL19", RZ_RELOC_BASE_GOT_SYMBOL);
	case R_AARCH64_P32_GOT_LD_PREL19: ADD(32, -P, "R_AARCH64_P32_GOT_LD_PREL19", RZ_RELOC_BASE_GOT_SYMBOL);
	case R_AARCH64_LD64_GOTOFF_LO15: ADD(32, -GOT, "R_AARCH64_LD64_GOTOFF_LO15", RZ_RELOC_BASE_GOT_SYMBOL);
	case R_AARCH64_ADR_GOT_PAGE: UNHANDL("R_AARCH64_ADR_GOT_PAGE");
	case R_AARCH64_P32_ADR_GOT_PAGE: UNHANDL("R_AARCH64_P32_ADR_GOT_PAGE");
	case R_AARCH64_LD64_GOT_LO12_NC: UNHANDL("R_AARCH64_LD64_GOT_LO12_NC");
	case R_AARCH64_P32_LD32_GOT_LO12_NC: UNHANDL("R_AARCH64_P32_LD32_GOT_LO12_NC");
	case R_AARCH64_LD64_GOTPAGE_LO15: UNHANDL("R_AARCH64_LD64_GOTPAGE_LO15");
	case R_AARCH64_P32_LD32_GOTPAGE_LO14: UNHANDL("R_AARCH64_P32_LD32_GOTPAGE_LO14");
	case R_AARCH64_TLSGD_ADR_PREL21: UNHANDL("R_AARCH64_TLSGD_ADR_PREL21");
	case R_AARCH64_P32_TLSGD_ADR_PREL21: UNHANDL("R_AARCH64_P32_TLSGD_ADR_PREL21");
	case R_AARCH64_TLSGD_ADR_PAGE21: UNHANDL("R_AARCH64_TLSGD_ADR_PAGE21");
	case R_AARCH64_P32_TLSGD_ADR_PAGE21: UNHANDL("R_AARCH64_P32_TLSGD_ADR_PAGE21");
	case R_AARCH64_TLSGD_ADD_LO12_NC: UNHANDL("R_AARCH64_TLSGD_ADD_LO12_NC");
	case R_AARCH64_P32_TLSGD_ADD_LO12_NC: UNHANDL("R_AARCH64_P32_TLSGD_ADD_LO12_NC");
	...
	case R_AARCH64_P32_TLSLD_ADR_PREL21: UNHANDL("R_AARCH64_P32_TLSLD_ADR_PREL21");
	case R_AARCH64_TLSLD_ADR_PAGE21: UNHANDL("R_AARCH64_TLSLD_ADR_PAGE21");
	case R_AARCH64_P32_TLSLD_ADR_PAGE21: UNHANDL("R_AARCH64_P32_TLSLD_ADR_PAGE21");
	case R_AARCH64_TLSLD_ADD_LO12_NC: UNHANDL("R_AARCH64_TLSLD_ADD_LO12_NC");
	case R_AARCH64_P32_TLSLD_ADD_LO12_NC: UNHANDL("R_AARCH64_P32_TLSLD_ADD_LO12_NC");
	...
	case R_AARCH64_P32_TLSLD_LD_PREL19: UNHANDL("R_AARCH64_P32_TLSLD_LD_PREL19");
	...
	case R_AARCH64_P32_TLSLD_MOVW_DTPREL_G1: UNHANDL("R_AARCH64_P32_TLSLD_MOVW_DTPREL_G1");
	...
	case R_AARCH64_P32_TLSLD_MOVW_DTPREL_G0: UNHANDL("R_AARCH64_P32_TLSLD_MOVW_DTPREL_G0");
	case R_AARCH64_TLSLD_MOVW_DTPREL_G0_NC: UNHANDL("R_AARCH64_TLSLD_MOVW_DTPREL_G0_NC");
	case R_AARCH64_P32_TLSLD_MOVW_DTPREL_G0_NC: UNHANDL("R_AARCH64_P32_TLSLD_MOVW_DTPREL_G0_NC");
	case R_AARCH64_TLSLD_ADD_DTPREL_HI12: UNHANDL("R_AARCH64_TLSLD_ADD_DTPREL_HI12");
	case R_AARCH64_P32_TLSLD_ADD_DTPREL_HI12: UNHANDL("R_AARCH64_P32_TLSLD_ADD_DTPREL_HI12");
	case R_AARCH64_TLSLD_ADD_DTPREL_LO12: UNHANDL("R_AARCH64_TLSLD_ADD_DTPREL_LO12");
	case R_AARCH64_P32_TLSLD_ADD_DTPREL_LO12: UNHANDL("R_AARCH64_P32_TLSLD_ADD_DTPREL_LO12");
	case R_AARCH64_TLSLD_ADD_DTPREL_LO12_NC: UNHANDL("R_AARCH64_TLSLD_ADD_DTPREL_LO12_NC");
	case R_AARCH64_P32_TLSLD_ADD_DTPREL_LO12_NC: UNHANDL("R_AARCH64_P32_TLSLD_ADD_DTPREL_LO12_NC");
	case R_AARCH64_TLSLD_LDST8_DTPREL_LO12: UNHANDL("R_AARCH64_TLSLD_LDST8_DTPREL_LO12");
	case R_AARCH64_P32_TLSLD_LDST8_DTPREL_LO12: UNHANDL("R_AARCH64_P32_TLSLD_LDST8_DTPREL_LO12");
	case R_AARCH64_TLSLD_LDST8_DTPREL_LO12_NC: UNHANDL("R_AARCH64_TLSLD_LDST8_DTPREL_LO12_NC");
	case R_AARCH64_P32_TLSLD_LDST8_DTPREL_LO12_NC: UNHANDL("R_AARCH64_P32_TLSLD_LDST8_DTPREL_LO12_NC");
	case R_AARCH64_TLSLD_LDST16_DTPREL_LO12: UNHANDL("R_AARCH64_TLSLD_LDST16_DTPREL_LO12");
	case R_AARCH64_P32_TLSLD_LDST16_DTPREL_LO12: UNHANDL("R_AARCH64_P32_TLSLD_LDST16_DTPREL_LO12");
	case R_AARCH64_TLSLD_LDST16_DTPREL_LO12_NC: UNHANDL("R_AARCH64_TLSLD_LDST16_DTPREL_LO12_NC");
	case R_AARCH64_P32_TLSLD_LDST16_DTPREL_LO12_NC: UNHANDL("R_AARCH64_P32_TLSLD_LDST16_DTPREL_LO12_NC");
	case R_AARCH64_TLSLD_LDST32_DTPREL_LO12: UNHANDL("R_AARCH64_TLSLD_LDST32_DTPREL_LO12");
	case R_AARCH64_P32_TLSLD_LDST32_DTPREL_LO12: UNHANDL("R_AARCH64_P32_TLSLD_LDST32_DTPREL_LO12");
	case R_AARCH64_TLSLD_LDST32_DTPREL_LO12_NC: UNHANDL("R_AARCH64_TLSLD_LDST32_DTPREL_LO12_NC");
	case R_AARCH64_P32_TLSLD_LDST32_DTPREL_LO12_NC: UNHANDL("R_AARCH64_P32_TLSLD_LDST32_DTPREL_LO12_NC");
	case R_AARCH64_TLSLD_LDST64_DTPREL_LO12: UNHANDL("R_AARCH64_TLSLD_LDST64_DTPREL_LO12");
	case R_AARCH64_P32_TLSLD_LDST64_DTPREL_LO12: UNHANDL("R_AARCH64_P32_TLSLD_LDST64_DTPREL_LO12");
	case R_AARCH64_TLSLD_LDST64_DTPREL_LO12_NC: UNHANDL("R_AARCH64_TLSLD_LDST64_DTPREL_LO12_NC");
	case R_AARCH64_P32_TLSLD_LDST64_DTPREL_LO12_NC: UNHANDL("R_AARCH64_P32_TLSLD_LDST64_DTPREL_LO12_NC");
	case R_AARCH64_TLSLD_LDST128_DTPREL_LO12: UNHANDL("R_AARCH64_TLSLD_LDST128_DTPREL_LO12");
	case R_AARCH64_P32_TLSLD_LDST128_DTPREL_LO12: UNHANDL("R_AARCH64_P32_TLSLD_LDST128_DTPREL_LO12");
	case R_AARCH64_TLSLD_LDST128_DTPREL_LO12_NC: UNHANDL("R_AARCH64_TLSLD_LDST128_DTPREL_LO12_NC");
	case R_AARCH64_P32_TLSLD_LDST128_DTPREL_LO12_NC: UNHANDL("R_AARCH64_P32_TLSLD_LDST128_DTPREL_LO12_NC");
	...
	case R_AARCH64_P32_TLSIE_ADR_GOTTPREL_PAGE21: UNHANDL("R_AARCH64_P32_TLSIE_ADR_GOTTPREL_PAGE21");
	case R_AARCH64_TLSIE_LD64_GOTTPREL_LO12_NC: UNHANDL("R_AARCH64_TLSIE_LD64_GOTTPREL_LO12_NC");
	case R_AARCH64_P32_TLSIE_LD32_GOTTPREL_LO12_NC: UNHANDL("R_AARCH64_P32_TLSIE_LD32_GOTTPREL_LO12_NC");
	case R_AARCH64_TLSIE_LD_GOTTPREL_PREL19: UNHANDL("R_AARCH64_TLSIE_LD_GOTTPREL_PREL19");
	case R_AARCH64_P32_TLSIE_LD_GOTTPREL_PREL19: UNHANDL("R_AARCH64_P32_TLSIE_LD_GOTTPREL_PREL19");
	...
	case R_AARCH64_P32_TLSLE_MOVW_TPREL_G1: UNHANDL("R_AARCH64_P32_TLSLE_MOVW_TPREL_G1");
	...
	case R_AARCH64_P32_TLSLE_MOVW_TPREL_G0: UNHANDL("R_AARCH64_P32_TLSLE_MOVW_TPREL_G0");
	case R_AARCH64_TLSLE_MOVW_TPREL_G0_NC: UNHANDL("R_AARCH64_TLSLE_MOVW_TPREL_G0_NC");
	case R_AARCH64_P32_TLSLE_MOVW_TPREL_G0_NC: UNHANDL("R_AARCH64_P32_TLSLE_MOVW_TPREL_G0_NC");
	case R_AARCH64_TLSLE_ADD_TPREL_HI12: UNHANDL("R_AARCH64_TLSLE_ADD_TPREL_HI12");
	case R_AARCH64_P32_TLSLE_ADD_TPREL_HI12: UNHANDL("R_AARCH64_P32_TLSLE_ADD_TPREL_HI12");
	case R_AARCH64_TLSLE_ADD_TPREL_LO12: UNHANDL("R_AARCH64_TLSLE_ADD_TPREL_LO12");
	case R_AARCH64_P32_TLSLE_ADD_TPREL_LO12: UNHANDL("R_AARCH64_P32_TLSLE_ADD_TPREL_LO12");
	case R_AARCH64_TLSLE_ADD_TPREL_LO12_NC: UNHANDL("R_AARCH64_TLSLE_ADD_TPREL_LO12_NC");
	case R_AARCH64_P32_TLSLE_ADD_TPREL_LO12_NC: UNHANDL("R_AARCH64_P32_TLSLE_ADD_TPREL_LO12_NC");
	case R_AARCH64_TLSLE_LDST8_TPREL_LO12: UNHANDL("R_AARCH64_TLSLE_LDST8_TPREL_LO12");
	case R_AARCH64_P32_TLSLE_LDST8_TPREL_LO12: UNHANDL("R_AARCH64_P32_TLSLE_LDST8_TPREL_LO12");
	case R_AARCH64_TLSLE_LDST8_TPREL_LO12_NC: UNHANDL("R_AARCH64_TLSLE_LDST8_TPREL_LO12_NC");
	case R_AARCH64_P32_TLSLE_LDST8_TPREL_LO12_NC: UNHANDL("R_AARCH64_P32_TLSLE_LDST8_TPREL_LO12_NC");
	case R_AARCH64_TLSLE_LDST16_TPREL_LO12: UNHANDL("R_AARCH64_TLSLE_LDST16_TPREL_LO12");
	case R_AARCH64_P32_TLSLE_LDST16_TPREL_LO12: UNHANDL("R_AARCH64_P32_TLSLE_LDST16_TPREL_LO12");
	case R_AARCH64_TLSLE_LDST16_TPREL_LO12_NC: UNHANDL("R_AARCH64_TLSLE_LDST16_TPREL_LO12_NC");
	case R_AARCH64_P32_TLSLE_LDST16_TPREL_LO12_NC: UNHANDL("R_AARCH64_P32_TLSLE_LDST16_TPREL_LO12_NC");
	case R_AARCH64_TLSLE_LDST32_TPREL_LO12: UNHANDL("R_AARCH64_TLSLE_LDST32_TPREL_LO12");
	case R_AARCH64_P32_TLSLE_LDST32_TPREL_LO12: UNHANDL("R_AARCH64_P32_TLSLE_LDST32_TPREL_LO12");
	case R_AARCH64_TLSLE_LDST32_TPREL_LO12_NC: UNHANDL("R_AARCH64_TLSLE_LDST32_TPREL_LO12_NC");
	case R_AARCH64_P32_TLSLE_LDST32_TPREL_LO12_NC: UNHANDL("R_AARCH64_P32_TLSLE_LDST32_TPREL_LO12_NC");
	case R_AARCH64_TLSLE_LDST64_TPREL_LO12: UNHANDL("R_AARCH64_TLSLE_LDST64_TPREL_LO12");
	case R_AARCH64_P32_TLSLE_LDST64_TPREL_LO12: UNHANDL("R_AARCH64_P32_TLSLE_LDST64_TPREL_LO12");
	case R_AARCH64_TLSLE_LDST64_TPREL_LO12_NC: UNHANDL("R_AARCH64_TLSLE_LDST64_TPREL_LO12_NC");
	case R_AARCH64_P32_TLSLE_LDST64_TPREL_LO12_NC: UNHANDL("R_AARCH64_P32_TLSLE_LDST64_TPREL_LO12_NC");
	case R_AARCH64_TLSLE_LDST128_TPREL_LO12: UNHANDL("R_AARCH64_TLSLE_LDST128_TPREL_LO12");
	case R_AARCH64_P32_TLSLE_LDST128_TPREL_LO12: UNHANDL("R_AARCH64_P32_TLSLE_LDST128_TPREL_LO12");
	case R_AARCH64_TLSLE_LDST128_TPREL_LO12_NC: UNHANDL("R_AARCH64_TLSLE_LDST128_TPREL_LO12_NC");
	case R_AARCH64_P32_TLSLE_LDST128_TPREL_LO12_NC: UNHANDL("R_AARCH64_P32_TLSLE_LDST128_TPREL_LO12_NC");
	case R_AARCH64_TLSDESC_LD_PREL19: UNHANDL("R_AARCH64_TLSDESC_LD_PREL19");
	case R_AARCH64_P32_TLSDESC_LD_PREL19: UNHANDL("R_AARCH64_P32_TLSDESC_LD_PREL19");
	case R_AARCH64_TLSDESC_ADR_PREL21: UNHANDL("R_AARCH64_TLSDESC_ADR_PREL21");
	case R_AARCH64_P32_TLSDESC_ADR_PREL21: UNHANDL("R_AARCH64_P32_TLSDESC_ADR_PREL21");
	case R_AARCH64_TLSDESC_ADR_PAGE21: UNHANDL("R_AARCH64_TLSDESC_ADR_PAGE21");
	case R_AARCH64_P32_TLSDESC_ADR_PAGE21: UNHANDL("R_AARCH64_P32_TLSDESC_ADR_PAGE21");
	case R_AARCH64_TLSDESC_LD64_LO12: UNHANDL("R_AARCH64_TLSDESC_LD64_LO12");
	case R_AARCH64_P32_TLSDESC_LD32_LO12: UNHANDL("R_AARCH64_P32_TLSDESC_LD32_LO12");
	case R_AARCH64_TLSDESC_ADD_LO12: UNHANDL("R_AARCH64_TLSDESC_ADD_LO12");
	case R_AARCH64_P32_TLSDESC_ADD_LO12: UNHANDL("R_AARCH64_P32_TLSDESC_ADD_LO12");
	...
	case R_AARCH64_P32_TLSDESC_CALL: UNHANDL("R_AARCH64_P32_TLSDESC_CALL");
	...
	case R_AARCH64_P32_GLOB_DAT: ADD(32, 0, "R_AARCH64_P32_GLOB_DAT", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_JUMP_SLOT: ADD(64, 0, "R_AARCH64_JUMP_SLOT", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_P32_JUMP_SLOT: ADD(32, 0, "R_AARCH64_P32_JUMP_SLOT", RZ_RELOC_BASE_SYMBOL);
	case R_AARCH64_RELATIVE: ADD(64, 0, "R_AARCH64_RELATIVE", RZ_RELOC_BASE_BASE);
	case R_AARCH64_P32_RELATIVE: ADD(32, 0, "R_AARCH64_P32_RELATIVE", RZ_RELOC_BASE_BASE);
	case R_AARCH64_TLS_IMPDEF1: UNHANDL("R_AARCH64_TLS_IMPDEF1");
	case R_AARCH64_P32_TLS_IMPDEF1: UNHANDL("R_AARCH64_P32_TLS_IMPDEF1");
	case R_AARCH64_TLS_IMPDEF2: UNHANDL("R_AARCH64_TLS_IMPDEF2");
	case R_AARCH64_P32_TLS_IMPDEF2: UNHANDL("R_AARCH64_P32_TLS_IMPDEF2");
	...
	case R_AARCH64_IRELATIVE: ADD(64, 0, "R_AARCH64_IRELATIVE", RZ_RELOC_BASE_BASE);
	case R_AARCH64_P32_IRELATIVE: ADD(32, 0, "R_AARCH64_P32_IRELATIVE", RZ_RELOC_BASE_BASE);
	case R_AARCH64_AUTH_ABS64: UNHANDL("R_AARCH64_AUTH_ABS64");
	case R_AARCH64_AUTH_MOVW_GOTOFF_G0: UNHANDL("R_AARCH64_AUTH_MOVW_GOTOFF_G0");
	case R_AARCH64_AUTH_MOVW_GOTOFF_G0_NC: UNHANDL("R_AARCH64_AUTH_MOVW_GOTOFF_G0_NC");
	case R_AARCH64_AUTH_MOVW_GOTOFF_G1: UNHANDL("R_AARCH64_AUTH_MOVW_GOTOFF_G1");
	case R_AARCH64_AUTH_MOVW_GOTOFF_G1_NC: UNHANDL("R_AARCH64_AUTH_MOVW_GOTOFF_G1_NC");
	case R_AARCH64_AUTH_MOVW_GOTOFF_G2: UNHANDL("R_AARCH64_AUTH_MOVW_GOTOFF_G2");
	case R_AARCH64_AUTH_MOVW_GOTOFF_G2_NC: UNHANDL("R_AARCH64_AUTH_MOVW_GOTOFF_G2_NC");
	case R_AARCH64_AUTH_MOVW_GOTOFF_G3: UNHANDL("R_AARCH64_AUTH_MOVW_GOTOFF_G3");
	case R_AARCH64_AUTH_GOT_LD_PREL19: UNHANDL("R_AARCH64_AUTH_GOT_LD_PREL19");
	case R_AARCH64_AUTH_LD64_GOTOFF_LO15: UNHANDL("R_AARCH64_AUTH_LD64_GOTOFF_LO15");
	case R_AARCH64_AUTH_ADR_GOT_PAGE: UNHANDL("R_AARCH64_AUTH_ADR_GOT_PAGE");
	case R_AARCH64_AUTH_LD64_GOT_LO12_NC: UNHANDL("R_AARCH64_AUTH_LD64_GOT_LO12_NC");
	case R_AARCH64_AUTH_LD64_GOTPAGE_LO15: UNHANDL("R_AARCH64_AUTH_LD64_GOTPAGE_LO15");
	case R_AARCH64_AUTH_GOT_ADD_LO12_NC: UNHANDL("R_AARCH64_AUTH_GOT_ADD_LO12_NC");
	case R_AARCH64_AUTH_GOT_ADR_PREL_LO21: UNHANDL("R_AARCH64_AUTH_GOT_ADR_PREL_LO21");
	case R_AARCH64_AUTH_TLSDESC_ADR_PAGE21: UNHANDL("R_AARCH64_AUTH_TLSDESC_ADR_PAGE21");
	case R_AARCH64_AUTH_TLSDESC_LD64_LO12: UNHANDL("R_AARCH64_AUTH_TLSDESC_LD64_LO12");
	case R_AARCH64_AUTH_TLSDESC_ADD_LO12: UNHANDL("R_AARCH64_AUTH_TLSDESC_ADD_LO12");
	// FIXME: Quite a few relocations missing here
...
static RzBinReloc *reloc_convert_ppc64(ELFOBJ *bin, RzBinElfReloc *rel, ut64 GOT) {
	...
	case R_PPC64_RELATIVE: ADD(64, 0, "R_PPC64_RELATIVE", RZ_RELOC_BASE_BASE);
	...
	case R_PPC64_ADDR64: ADD(64, 0, "R_PPC64_ADDR64", RZ_RELOC_BASE_SYMBOL);
...
static RzBinReloc *reloc_convert_mips(ELFOBJ *bin, RzBinElfReloc *rel, ut64 GOT) {
	...
	case R_MIPS_26: ADD(32, -P, "R_MIPS_26", RZ_RELOC_BASE_SYMBOL);
	case R_MIPS_HI16: ADD(32, 0, "R_MIPS_HI16", RZ_RELOC_BASE_SYMBOL);
	case R_MIPS_LO16: ADD(32, 0, "R_MIPS_LO16", RZ_RELOC_BASE_SYMBOL);
	case R_MIPS_GPREL16: UNHANDL("R_MIPS_GPREL16");
	case R_MIPS_LITERAL: UNHANDL("R_MIPS_LITERAL");
	case R_MIPS_GOT16: ADD(16, -GOT, "R_MIPS_GOT16", RZ_RELOC_BASE_SYMBOL);
	case R_MIPS_PC16: ADD(16, -P, "R_MIPS_PC16", RZ_RELOC_BASE_SYMBOL);
	case R_MIPS_CALL16: ADD(16, 0, "R_MIPS_CALL16", RZ_RELOC_BASE_SYMBOL);
	...
	case R_MIPS_64: ADD(64, 0, "R_MIPS_64", RZ_RELOC_BASE_SYMBOL);
	...
	case R_MIPS_GOT_HI16: ADD(32, -GOT, "R_MIPS_GOT_HI16", RZ_RELOC_BASE_SYMBOL);
	case R_MIPS_GOT_LO16: ADD(32, -GOT, "R_MIPS_GOT_LO16", RZ_RELOC_BASE_SYMBOL);
	...
	case R_MIPS_CALL_HI16: ADD(32, 0, "R_MIPS_CALL_HI16", RZ_RELOC_BASE_SYMBOL);
	case R_MIPS_CALL_LO16: ADD(32, 0, "R_MIPS_CALL_LO16", RZ_RELOC_BASE_SYMBOL);
	case R_MIPS_SCN_DISP: UNHANDL("R_MIPS_SCN_DISP");
	case R_MIPS_REL16: ADD(16, -P, "R_MIPS_REL16", RZ_RELOC_BASE_SYMBOL);
...
// https://web.archive.org/web/20260906194722/https://www.ti.com/lit/an/sprab89b/sprab89b.pdf
//
// Data relocations (ABS8/16/32) resolve to a flat symbol value; the many
// instruction-field relocations (MVKL/MVKH halves, static-base and PC-relative
// displacements) patch a bit field inside a 32-bit opcode, so they are exposed
// with their width but no directly resolvable value. Framing and attribute
// relocations (ALIGN/FPHEAD/NOCMP) patch nothing.
static RzBinReloc *reloc_convert_c6000(ELFOBJ *bin, RzBinElfReloc *rel, ut64 GOT) {
	...
	case R_C6000_SBR_U15_B: ADD(16, 0, "R_C6000_SBR_U15_B", RZ_RELOC_BASE_SYMBOL);
	case R_C6000_SBR_U15_H: ADD(16, 0, "R_C6000_SBR_U15_H", RZ_RELOC_BASE_SYMBOL);
	case R_C6000_SBR_U15_W: ADD(16, 0, "R_C6000_SBR_U15_W", RZ_RELOC_BASE_SYMBOL);
	case R_C6000_SBR_S16: ADD(16, 0, "R_C6000_SBR_S16", RZ_RELOC_BASE_SYMBOL);
	case R_C6000_SBR_L16_B: ADD(16, 0, "R_C6000_SBR_L16_B", RZ_RELOC_BASE_SYMBOL);
	case R_C6000_SBR_L16_H: ADD(16, 0, "R_C6000_SBR_L16_H", RZ_RELOC_BASE_SYMBOL);
	case R_C6000_SBR_L16_W: ADD(16, 0, "R_C6000_SBR_L16_W", RZ_RELOC_BASE_SYMBOL);
	case R_C6000_SBR_H16_B: ADD(16, 0, "R_C6000_SBR_H16_B", RZ_RELOC_BASE_SYMBOL);
	case R_C6000_SBR_H16_H: ADD(16, 0, "R_C6000_SBR_H16_H", RZ_RELOC_BASE_SYMBOL);
	case R_C6000_SBR_H16_W: ADD(16, 0, "R_C6000_SBR_H16_W", RZ_RELOC_BASE_SYMBOL);
