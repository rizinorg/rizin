...
RZ_API void rz_core_bin_entries_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
RZ_API void rz_core_bin_initfini_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
RZ_API void rz_core_bin_exports_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state, RzCoreBinFilter *filter);
RZ_API void rz_core_bin_cur_export_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
RZ_API void rz_core_bin_symbols_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state, RzCoreBinFilter *filter);
RZ_API void rz_core_bin_cur_symbol_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
RZ_API void rz_core_bin_imports_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state, RzCoreBinFilter *filter);
RZ_API void rz_core_bin_libs_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
RZ_API void rz_core_bin_main_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
RZ_API void rz_core_bin_relocs_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
RZ_API void rz_core_bin_sections_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state, RzCoreBinFilter *filter, RzList *hashes);
RZ_API void rz_core_bin_cur_section_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state, RzList *hashes);
RZ_API void rz_core_bin_segments_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state, RzCoreBinFilter *filter, RzList *hashes);
RZ_API void rz_core_bin_strings_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
RZ_API void rz_core_bin_whole_strings_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
RZ_API void rz_core_file_info_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
RZ_API void rz_core_bin_info_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
RZ_API void rz_core_bin_classes_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
...
RZ_API void rz_core_bin_signatures_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
RZ_API void rz_core_bin_fields_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
RZ_API void rz_core_bin_headers_print(RZ_NONNULL RzCore *core);
RZ_API void rz_core_bin_dwarf_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
RZ_API RZ_OWN char *rz_core_bin_pdb_get_filename(RZ_NONNULL RzCore *core);
RZ_API void rz_core_bin_memory_print(RZ_NONNULL RzCore *core, RZ_NONNULL RzCmdStateOutput *state);
