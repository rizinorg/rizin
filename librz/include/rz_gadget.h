...
typedef struct rz_gadget_search_context_t {
	...
	ut8 subchain; ///< Display every length gadget from gadget.len=X to 2 in /Rl.
	ut8 crop; ///< Include conditional jump, calls and returns in gadget search.
...
RZ_API bool rz_core_handle_gadget_request_type(RZ_NONNULL RzCore *core, RZ_NONNULL RzGadgetSearchContext *context, RZ_NONNULL RzList /*<RzCoreAsmHit *>*/ *hitlist);
