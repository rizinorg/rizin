...
#define FRSQRT(rmode, fl)          rz_il_op_new_fsucc(rmode, fl)
...
#define FHYPOT(rmode, flx, fly)    rz_il_op_new_fhypot(rmode, flx, fly)
...
#define FROOTN(rmode, flx, n)      rz_il_op_new_frootn(rmode, flx, n)
#define FPOWN(rmode, flx, n)       rz_il_op_new_fpown(rmode, flx, n)
#define FCOMPOUND(rmode, flx, n)   rz_il_op_new_fcompund(rmode, flx, n)
