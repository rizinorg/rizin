...
RZ_API void rz_il_dump_list(RZ_NONNULL RzPVector *oplist, RZ_NONNULL RzStrBuf *sb);
RZ_API void rz_il_json_list(RZ_NONNULL RzPVector *oplist, RZ_NONNULL PJ *pj);
