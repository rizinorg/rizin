...
RZ_API RzList /*<char *>*/ *rz_str_split_duplist(RZ_NONNULL const char *str, RZ_NONNULL const char *c, bool trim);
RZ_API RzList /*<char *>*/ *rz_str_split_duplist_n(RZ_NONNULL const char *str, RZ_NONNULL const char *c, int n, bool trim);
