...
RZ_API int rz_core_config_init(RzCore *core) {
	...
	SETICB("search.str.max_length", RZ_BIN_STRING_SEARCH_BUFFER_SIZE, &cb_search_str_max_length, "Maximum buffer size, which will also determine the maximum string length in bytes (inclusive).");
