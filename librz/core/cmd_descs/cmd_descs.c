...
static const RzCmdDescDetailEntry aap_Examples_detail_entries[] = {
	...
	{ .text = "aapf x86_prologues.json", .arg_str = "", .comment = "Load and analyse prologues signatures from the json file" },
...
static const RzCmdDescHelp load_and_analyze_all_preludes_help = {
	.summary = "Load and analyse prologues signatures from the json file (generated by prologues generator plugin)",
