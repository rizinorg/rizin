...
static const RzCmdDescDetail aap_details[2];
...
static const RzCmdDescArg cmd_search_str_chunk_args[2];
static const RzCmdDescArg cmd_search_assemble_args[2];
static const RzCmdDescArg cmd_search_assemble_1_args[2];
static const RzCmdDescArg cmd_search_assemble_a_args[2];
static const RzCmdDescArg cmd_search_assemble_c_args[2];
static const RzCmdDescArg cmd_search_assemble_d_args[2];
...
static const RzCmdDescArg load_and_analyze_all_preludes_args[2];
static const RzCmdDescArg analyze_all_preludes_keyword_args[2];
...
static const RzCmdDescArg plugins_asm_cpu_print_args[2];
...
static const RzCmdDescArg print_hexdump_comments_alias_args[2];
...
static const RzCmdDescArg cmd_search_str_chunk_args[] = {
	{
		.name = "/bin/sh",
		.type = RZ_CMD_ARG_TYPE_STRING,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp cmd_search_str_chunk_help = {
	.summary = "Construct the string with chunks.",
	.args = cmd_search_str_chunk_args,
};
...
static const RzCmdDescArg cmd_search_assemble_1_args[] = {
	{
		.name = "number",
		.type = RZ_CMD_ARG_TYPE_STRING,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp cmd_search_assemble_1_help = {
	.summary = "Find valid assembly generated by changing only the nth byte",
	.args = cmd_search_assemble_1_args,
};

static const RzCmdDescArg cmd_search_assemble_I_args[] = {
	{ 0 },
};
static const RzCmdDescHelp cmd_search_assemble_I_help = {
	.summary = "Search for infinite loop instructions (jmp $$)",
	.args = cmd_search_assemble_I_args,
};

static const RzCmdDescArg cmd_search_assemble_a_args[] = {
	{
		.name = "asm-text",
		.type = RZ_CMD_ARG_TYPE_STRING,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp cmd_search_assemble_a_help = {
	.summary = "Linearly find aproximated assembly (case insensitive strstr)",
	.args = cmd_search_assemble_a_args,
};

static const RzCmdDescArg cmd_search_assemble_c_args[] = {
	{
		.name = "asm-text",
		.type = RZ_CMD_ARG_TYPE_STRING,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp cmd_search_assemble_c_help = {
	.summary = "Same as /aa, but case-sensitive",
	.args = cmd_search_assemble_c_args,
};

static const RzCmdDescArg cmd_search_assemble_d_args[] = {
	{
		.name = "mnem;mov",
		.type = RZ_CMD_ARG_TYPE_STRING,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp cmd_search_assemble_d_help = {
	.summary = "Match ins1 followed by ins2 in linear disasm",
	.args = cmd_search_assemble_d_args,
};

static const RzCmdDescArg cmd_search_assemble_d_slash_args[] = {
	{
		.name = "ins1;ins2",
		.type = RZ_CMD_ARG_TYPE_STRING,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp cmd_search_assemble_d_slash_help = {
	.summary = "Search for regex instruction 'ins1' followed by regex 'ins2'",
	.args = cmd_search_assemble_d_slash_args,
};

static const RzCmdDescArg cmd_search_assemble_d_slasha_args[] = {
	{
		.name = "instr",
		.type = RZ_CMD_ARG_TYPE_STRING,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp cmd_search_assemble_d_slasha_help = {
	.summary = "Search for every byte instruction that matches regexp 'instr'",
	.args = cmd_search_assemble_d_slasha_args,
};

static const RzCmdDescArg cmd_search_assemble_e_args[] = {
	{
		.name = "esil",
		.type = RZ_CMD_ARG_TYPE_STRING,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp cmd_search_assemble_e_help = {
...
static const RzCmdDescHelp cmd_search_assemble_f_help = {
	.summary = "Search for instruction of specific family (afl=list",
...
static const RzCmdDescHelp cmd_search_assemble_fl_help = {
	.summary = "Search for instruction of specific family. List mode.",
	.args = cmd_search_assemble_fl_args,
};
...
static const RzCmdDescArg cmd_search_assemble_l_args[] = {
	{ 0 },
};
static const RzCmdDescHelp cmd_search_assemble_l_help = {
	.summary = "Same as aoml, list all opcodes",
	.args = cmd_search_assemble_l_args,
};

static const RzCmdDescArg cmd_search_assemble_m_args[] = {
	{
		.name = "opcode",
		.type = RZ_CMD_ARG_TYPE_STRING,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp cmd_search_assemble_m_help = {
	.summary = "Search for specific instructions of specific mnemonic",
	.args = cmd_search_assemble_m_args,
};

static const RzCmdDescArg cmd_search_assemble_o_args[] = {
	{
		.name = "instr",
		.type = RZ_CMD_ARG_TYPE_STRING,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp cmd_search_assemble_o_help = {
...
static const RzCmdDescHelp cmd_search_assemble_s_help = {
	.summary = "Search for syscalls (See /at swi and /af priv)",
...
static const RzCmdDescHelp cmd_search_assemble_sl_help = {
...
static const RzCmdDescHelp cmd_search_assemble_t_help = {
	.summary = "Search for instructions of given type",
...
static const RzCmdDescHelp cmd_search_assemble_tl_help = {
	.summary = "Search for instructions of given type. List mode.",
	.args = cmd_search_assemble_tl_args,
};
...
static const RzCmdDescHelp cmd_search_deltified_help = {
...
static const RzCmdDescHelp cmd_search_insn_offset_backwards_help = {
	.summary = "Show offset of n instructions backward.",
	.args = cmd_search_insn_offset_backwards_args,
};

static const RzCmdDescArg cmd_search_insn_offset_backwards_fallback_args[] = {
	{
		.name = "n",
		.type = RZ_CMD_ARG_TYPE_STRING,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp cmd_search_insn_offset_backwards_fallback_help = {
	.summary = "Same as /o, but with a different fallback if analysis cannot be used.",
	.args = cmd_search_insn_offset_backwards_fallback_args,
};

static const RzCmdDescArg cmd_search_pattern_args[] = {
	{
		.name = "patternsize",
		.type = RZ_CMD_ARG_TYPE_STRING,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp cmd_search_pattern_help = {
	.summary = "Search for pattern of given size.",
	.args = cmd_search_pattern_args,
};
...
static const RzCmdDescHelp cmd_search_blocks_help = {
...
static const RzCmdDescArg cmd_search_magic_bin_headers_args[] = {
	{ 0 },
};
...
static const RzCmdDescArg cmd_search_reference_all_args[] = {
	{ 0 },
};
static const RzCmdDescHelp cmd_search_reference_all_help = {
	.summary = "Search all references.",
	.args = cmd_search_reference_all_args,
};

static const RzCmdDescArg cmd_search_reference_call_args[] = {
	{ 0 },
};
static const RzCmdDescHelp cmd_search_reference_call_help = {
	.summary = "Search call references.",
	.args = cmd_search_reference_call_args,
};

static const RzCmdDescArg cmd_search_reference_read_args[] = {
	{ 0 },
};
static const RzCmdDescHelp cmd_search_reference_read_help = {
	.summary = "Search read references.",
	.args = cmd_search_reference_read_args,
};

static const RzCmdDescArg cmd_search_reference_write_args[] = {
	{ 0 },
};
static const RzCmdDescHelp cmd_search_reference_write_help = {
	.summary = "Search write references.",
	.args = cmd_search_reference_write_args,
};

static const RzCmdDescArg cmd_search_reference_execute_args[] = {
	{ 0 },
};
static const RzCmdDescHelp cmd_search_reference_execute_help = {
...
static const RzCmdDescDetailEntry aap_Examples_detail_entries[] = {
	{ .text = "aap", .arg_str = "", .comment = "Search for static arch preludes and create new functions on hit" },
	{ .text = "aapf x86_prologues.json", .arg_str = "", .comment = "Load prologues signatures from the json file (generated by prologues generator plugin) and analyse current binary" },
	{ .text = "aapk 0x90aef630:0xffafdfff", .arg_str = "", .comment = "Search for prologue keyword (<bytes>:<mask>) and create new functions on hit" },
	{ 0 },
};
static const RzCmdDescDetail aap_details[] = {
	{ .name = "Examples", .entries = aap_Examples_detail_entries },
	{ 0 },
};
static const RzCmdDescHelp aap_help = {
	.summary = "Analyze preludes",
	.details = aap_details,
};
...
static const RzCmdDescHelp analyze_all_preludes_help = {
	.summary = "Analyze all static arch preludes",
	.args = analyze_all_preludes_args,
};

static const RzCmdDescArg load_and_analyze_all_preludes_args[] = {
	{
		.name = "file",
		.type = RZ_CMD_ARG_TYPE_FILE,
		.optional = false,
...
static const RzCmdDescHelp load_and_analyze_all_preludes_help = {
	.summary = "Load prologues signatures from the json file (generated by prologues generator plugin) and analyse current binary",
	.args = load_and_analyze_all_preludes_args,
};

static const RzCmdDescArg analyze_all_preludes_keyword_args[] = {
	{
		.name = "keyword",
		.type = RZ_CMD_ARG_TYPE_STRING,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp analyze_all_preludes_keyword_help = {
	.summary = "Search for a prologue keyword and create new functions on hit",
	.args = analyze_all_preludes_keyword_args,
};
...
static const RzCmdDescHelp cmd_heap_bins_list_print_help = {
	.summary = "Display double linked list for bins in an arena.",
...
static const RzCmdDescHelp La_help = {
...
static const RzCmdDescHelp plugins_asm_print_help = {
	.summary = "List the arch plugins",
	.details = plugins_asm_print_details,
	.args = plugins_asm_print_args,
};

static const RzCmdDescArg plugins_asm_cpu_print_args[] = {
	{
		.name = "architecture",
		.type = RZ_CMD_ARG_TYPE_STRING,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp plugins_asm_cpu_print_help = {
	.summary = "List the cpus supported by the arch plugin",
	.args = plugins_asm_cpu_print_args,
};
...
static const RzCmdDescArg interactive_visual_config_args[] = {
	{ 0 },
};
static const RzCmdDescHelp interactive_visual_config_help = {
	.summary = "Enter interactive visual mode and select the configurations toggle (alias for 'V e').",
	.args = interactive_visual_config_args,
};

static const RzCmdDescArg interactive_visual_graph_args[] = {
	{ 0 },
};
static const RzCmdDescHelp interactive_visual_graph_help = {
	.summary = "Enter interactive visual mode and select the function graph (alias for 'V V').",
	.args = interactive_visual_graph_args,
};
...
static const RzCmdDescArg print_hexdump_comments_alias_args[] = {
	{
		.name = "len",
		.type = RZ_CMD_ARG_TYPE_RZNUM,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp print_hexdump_comments_alias_help = {
	.summary = "Alias for 'pxc' (show hexdump with comments).",
	.args = print_hexdump_comments_alias_args,
};
...
RZ_IPI void rzshell_cmddescs_init(RzCore *core) {
	...
	RzCmdDesc *oparen__cd = rz_cmd_desc_group_state_new(core->rcmd, root_cd, "(", RZ_OUTPUT_MODE_STANDARD, rz_macros_list_handler, &macros_list_help, &oparen__help);
	...
	RzCmdDesc *cmd_search_str_chunk_cd = rz_cmd_desc_argv_modes_new(core->rcmd, slash__cd, "/+", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_TABLE, rz_cmd_search_str_chunk_handler, &cmd_search_str_chunk_help);
	...
	rz_warn_if_fail(cmd_search_assemble_d_cd);

	RzCmdDesc *cmd_search_assemble_d_slash_cd = rz_cmd_desc_argv_new(core->rcmd, slash_a_cd, "/ad/", rz_cmd_search_assemble_d_slash_handler, &cmd_search_assemble_d_slash_help);
	rz_warn_if_fail(cmd_search_assemble_d_slash_cd);
	...
	RzCmdDesc *cmd_search_pattern_cd = rz_cmd_desc_argv_state_new(core->rcmd, slash__cd, "/p", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_TABLE, rz_cmd_search_pattern_handler, &cmd_search_pattern_help);
	rz_warn_if_fail(cmd_search_pattern_cd);

	RzCmdDesc *cmd_search_blocks_cd = rz_cmd_desc_argv_state_new(core->rcmd, slash__cd, "/P", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_TABLE, rz_cmd_search_blocks_handler, &cmd_search_blocks_help);
	...
	RzCmdDesc *cmd_search_reference_all_cd = rz_cmd_desc_argv_new(core->rcmd, slash_r_cd, "/ra", rz_cmd_search_reference_all_handler, &cmd_search_reference_all_help);
	rz_warn_if_fail(cmd_search_reference_all_cd);

	RzCmdDesc *cmd_search_reference_call_cd = rz_cmd_desc_argv_new(core->rcmd, slash_r_cd, "/rc", rz_cmd_search_reference_call_handler, &cmd_search_reference_call_help);
	rz_warn_if_fail(cmd_search_reference_call_cd);

	RzCmdDesc *cmd_search_reference_read_cd = rz_cmd_desc_argv_new(core->rcmd, slash_r_cd, "/rr", rz_cmd_search_reference_read_handler, &cmd_search_reference_read_help);
	rz_warn_if_fail(cmd_search_reference_read_cd);

	RzCmdDesc *cmd_search_reference_write_cd = rz_cmd_desc_argv_new(core->rcmd, slash_r_cd, "/rw", rz_cmd_search_reference_write_handler, &cmd_search_reference_write_help);
	rz_warn_if_fail(cmd_search_reference_write_cd);
	...
	RzCmdDesc *aap_cd = rz_cmd_desc_group_new(core->rcmd, aa_cd, "aap", rz_analyze_all_preludes_handler, &analyze_all_preludes_help, &aap_help);
	rz_warn_if_fail(aap_cd);
	RzCmdDesc *load_and_analyze_all_preludes_cd = rz_cmd_desc_argv_new(core->rcmd, aap_cd, "aapf", rz_load_and_analyze_all_preludes_handler, &load_and_analyze_all_preludes_help);
	rz_warn_if_fail(load_and_analyze_all_preludes_cd);

	RzCmdDesc *analyze_all_preludes_keyword_cd = rz_cmd_desc_argv_new(core->rcmd, aap_cd, "aapk", rz_analyze_all_preludes_keyword_handler, &analyze_all_preludes_keyword_help);
	rz_warn_if_fail(analyze_all_preludes_keyword_cd);
	...
	RzCmdDesc *analyze_value_to_maps_cd = rz_cmd_desc_argv_state_new(core->rcmd, aa_cd, "aav", RZ_OUTPUT_MODE_STANDARD, rz_analyze_value_to_maps_handler, &analyze_value_to_maps_help);
	...
	RzCmdDesc *afb_cd = rz_cmd_desc_group_state_new(core->rcmd, af_cd, "afb", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_TABLE, rz_analysis_function_blocks_list_handler, &analysis_function_blocks_list_help, &afb_help);
	...
	RzCmdDesc *analysis_function_blocks_info_cd = rz_cmd_desc_argv_state_new(core->rcmd, afb_cd, "afbi", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_LONG | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_TABLE, rz_analysis_function_blocks_info_handler, &analysis_function_blocks_info_help);
	...
	RzCmdDesc *afv_cd = rz_cmd_desc_group_new(core->rcmd, af_cd, "afv", NULL, NULL, &afv_help);
	rz_warn_if_fail(afv_cd);
	RzCmdDesc *analysis_function_vars_cd = rz_cmd_desc_argv_state_new(core->rcmd, afv_cd, "afvl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_LONG, rz_analysis_function_vars_handler, &analysis_function_vars_help);
	rz_warn_if_fail(analysis_function_vars_cd);
	...
	RzCmdDesc *afvs_cd = rz_cmd_desc_group_state_new(core->rcmd, afv_cd, "afvs", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_analysis_function_vars_stack_handler, &analysis_function_vars_stack_help, &afvs_help);
	...
	RzCmdDesc *afvr_cd = rz_cmd_desc_group_state_new(core->rcmd, afv_cd, "afvr", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_analysis_function_vars_regs_handler, &analysis_function_vars_regs_help, &afvr_help);
	...
	RzCmdDesc *afl_cd = rz_cmd_desc_group_state_new(core->rcmd, af_cd, "afl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_LONG | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_TABLE, rz_analysis_function_list_handler, &analysis_function_list_help, &afl_help);
	...
	RzCmdDesc *analysis_function_cc_list_cd = rz_cmd_desc_argv_modes_new(core->rcmd, afc_cd, "afcl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_LONG | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_SDB, rz_analysis_function_cc_list_handler, &analysis_function_cc_list_help);
	...
	RzCmdDesc *ar_cd = rz_cmd_desc_group_state_new(core->rcmd, cmd_analysis_cd, "ar", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET, rz_analysis_regs_handler, &analysis_regs_help, &ar_help);
	...
	RzCmdDesc *analysis_regs_prev_cd = rz_cmd_desc_argv_state_new(core->rcmd, ar_cd, "aro", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET, rz_analysis_regs_prev_handler, &analysis_regs_prev_help);
	...
	RzCmdDesc *av_cd = rz_cmd_desc_group_modes_new(core->rcmd, cmd_analysis_cd, "av", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_analysis_list_vtables_handler, &analysis_list_vtables_help, &av_help);
	...
	RzCmdDesc *analysis_xrefs_graph_cd = rz_cmd_desc_argv_state_new(core->rcmd, ax_cd, "axg", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_analysis_xrefs_graph_handler, &analysis_xrefs_graph_help);
	...
	RzCmdDesc *analysis_hint_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, ah_cd, "ahl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_analysis_hint_list_handler, &analysis_hint_list_help);
	rz_warn_if_fail(analysis_hint_list_cd);

	RzCmdDesc *analysis_hint_list_at_cd = rz_cmd_desc_argv_state_new(core->rcmd, ah_cd, "ahl.", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_analysis_hint_list_at_handler, &analysis_hint_list_at_help);
	...
	RzCmdDesc *analysis_class_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, ac_cd, "acl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_LONG | RZ_OUTPUT_MODE_JSON, rz_analysis_class_list_handler, &analysis_class_list_help);
	...
	RzCmdDesc *analysis_basic_block_info_cd = rz_cmd_desc_argv_state_new(core->rcmd, ab_cd, "abi", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_LONG | RZ_OUTPUT_MODE_JSON, rz_analysis_basic_block_info_handler, &analysis_basic_block_info_help);
	rz_warn_if_fail(analysis_basic_block_info_cd);

	RzCmdDesc *analysis_basic_block_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, ab_cd, "abl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_LONG | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_QUIET, rz_analysis_basic_block_list_handler, &analysis_basic_block_list_help);
	...
	RzCmdDesc *cmd_cmp_list_compare_watchers_cd = rz_cmd_desc_argv_modes_new(core->rcmd, cw_cd, "cwl", RZ_OUTPUT_MODE_STANDARD, rz_cmd_cmp_list_compare_watchers_handler, &cmd_cmp_list_compare_watchers_help);
	...
	RzCmdDesc *C_cd = rz_cmd_desc_group_state_new(core->rcmd, root_cd, "C", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_LONG, rz_meta_list_handler, &meta_list_help, &C_help);
	rz_warn_if_fail(C_cd);
	RzCmdDesc *meta_list_at_cd = rz_cmd_desc_argv_state_new(core->rcmd, C_cd, "C.", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_LONG, rz_meta_list_at_handler, &meta_list_at_help);
	...
	RzCmdDesc *comment_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, CC_cd, "CCl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_LONG, rz_comment_list_handler, &comment_list_help);
	...
	RzCmdDesc *CCf_cd = rz_cmd_desc_group_state_new(core->rcmd, CC_cd, "CCf", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_LONG, rz_comment_function_list_handler, &comment_function_list_help, &CCf_help);
	...
	RzCmdDesc *meta_space_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, CS_cd, "CSl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET, rz_meta_space_list_handler, &meta_space_list_help);
	...
	RzCmdDesc *meta_format_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, Cf_cd, "Cfl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_meta_format_list_handler, &meta_format_list_help);
	...
	RzCmdDesc *meta_data_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, Cd_cd, "Cdl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_meta_data_list_handler, &meta_data_list_help);
	...
	RzCmdDesc *meta_hidden_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, Ch_cd, "Chl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_meta_hidden_list_handler, &meta_hidden_list_help);
	...
	RzCmdDesc *meta_magic_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, Cm_cd, "Cml", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_meta_magic_list_handler, &meta_magic_list_help);
	...
	rz_warn_if_fail(Cs_cd);
	RzCmdDesc *meta_string_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, Cs_cd, "Csl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET, rz_meta_string_list_handler, &meta_string_list_help);
	...
	RzCmdDesc *meta_type_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, Ct_cd, "Ctl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_meta_type_list_handler, &meta_type_list_help);
	...
	RzCmdDesc *meta_var_comment_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, Cv_cd, "Cvl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_meta_var_comment_list_handler, &meta_var_comment_list_help);
	rz_warn_if_fail(meta_var_comment_list_cd);

	RzCmdDesc *meta_var_reg_comment_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, Cv_cd, "Cvr", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_meta_var_reg_comment_list_handler, &meta_var_reg_comment_list_help);
	rz_warn_if_fail(meta_var_reg_comment_list_cd);

	RzCmdDesc *meta_var_stack_comment_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, Cv_cd, "Cvs", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_meta_var_stack_comment_list_handler, &meta_var_stack_comment_list_help);
	...
	RzCmdDesc *cmd_debug_list_bp_cd = rz_cmd_desc_argv_state_new(core->rcmd, db_cd, "dbl", RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET, rz_cmd_debug_list_bp_handler, &cmd_debug_list_bp_help);
	...
	RzCmdDesc *dbt_cd = rz_cmd_desc_group_state_new(core->rcmd, db_cd, "dbt", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_QUIET, rz_cmd_debug_display_bt_handler, &cmd_debug_display_bt_help, &dbt_help);
	...
	RzCmdDesc *cmd_debug_esil_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, de_cd, "del", RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_STANDARD, rz_cmd_debug_esil_list_handler, &cmd_debug_esil_list_help);
	...
	RzCmdDesc *cmd_debug_traces_cd = rz_cmd_desc_argv_state_new(core->rcmd, dt_cd, "dtl", RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD, rz_cmd_debug_traces_handler, &cmd_debug_traces_help);
	...
	RzCmdDesc *dtg_cd = rz_cmd_desc_group_modes_new(core->rcmd, dt_cd, "dtg", RZ_OUTPUT_MODE_STANDARD, rz_cmd_debug_trace_graph_handler, &cmd_debug_trace_graph_help, &dtg_help);
	...
	RzCmdDesc *debug_info_cd = rz_cmd_desc_argv_state_new(core->rcmd, d_cd, "di", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET, rz_debug_info_handler, &debug_info_help);
	...
	RzCmdDesc *dm_cd = rz_cmd_desc_group_state_new(core->rcmd, d_cd, "dm", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET, rz_cmd_debug_list_maps_handler, &cmd_debug_list_maps_help, &dm_help);
	...
	RzCmdDesc *cmd_debug_dmi_closest_cd = rz_cmd_desc_argv_state_new(core->rcmd, dmi_cd, "dmi.", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_QUIETEST, rz_cmd_debug_dmi_closest_handler, &cmd_debug_dmi_closest_help);
	...
	RzCmdDesc *dr_cd = rz_cmd_desc_group_state_new(core->rcmd, d_cd, "dr", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET, rz_debug_regs_handler, &debug_regs_help, &dr_help);
	...
	RzCmdDesc *debug_regs_prev_cd = rz_cmd_desc_argv_state_new(core->rcmd, dr_cd, "dro", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET, rz_debug_regs_prev_handler, &debug_regs_prev_help);
	...
	RzCmdDesc *eval_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, e_cd, "el", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_LONG | RZ_OUTPUT_MODE_LONG_JSON, rz_eval_list_handler, &eval_list_help);
	...
	RzCmdDesc *ec_cd = rz_cmd_desc_group_state_new(core->rcmd, e_cd, "ec", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_cmd_eval_color_list_handler, &cmd_eval_color_list_help, &ec_help);
	...
	RzCmdDesc *ecH_cd = rz_cmd_desc_group_modes_new(core->rcmd, ec_cd, "ecH", RZ_OUTPUT_MODE_JSON, rz_cmd_eval_color_highlight_list_handler, &cmd_eval_color_highlight_list_help, &ecH_help);
	...
	RzCmdDesc *flag_graph_cd = rz_cmd_desc_argv_state_new(core->rcmd, f_cd, "fg", RZ_OUTPUT_MODE_STANDARD, rz_flag_graph_handler, &flag_graph_help);
	rz_warn_if_fail(flag_graph_cd);

	RzCmdDesc *flag_range_cd = rz_cmd_desc_argv_state_new(core->rcmd, f_cd, "fi", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_TABLE, rz_flag_range_handler, &flag_range_help);
	rz_warn_if_fail(flag_range_cd);

	RzCmdDesc *flag_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, f_cd, "fl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_TABLE, rz_flag_list_handler, &flag_list_help);
	rz_warn_if_fail(flag_list_cd);

	RzCmdDesc *flag_list_at_cd = rz_cmd_desc_argv_state_new(core->rcmd, f_cd, "fl.", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_TABLE, rz_flag_list_at_handler, &flag_list_at_help);
	...
	RzCmdDesc *mark_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, m_cd, "ml", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_TABLE, rz_mark_list_handler, &mark_list_help);
	rz_warn_if_fail(mark_list_cd);

	RzCmdDesc *mark_list_at_cd = rz_cmd_desc_argv_state_new(core->rcmd, m_cd, "ml.", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_TABLE, rz_mark_list_at_handler, &mark_list_at_help);
	...
	RzCmdDesc *mark_range_cd = rz_cmd_desc_argv_state_new(core->rcmd, m_cd, "mi", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_TABLE, rz_mark_range_handler, &mark_range_help);
	...
	RzCmdDesc *cmd_info_pdb_show_cd = rz_cmd_desc_argv_state_new(core->rcmd, idp_cd, "idpi", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_cmd_info_pdb_show_handler, &cmd_info_pdb_show_help);
	...
	RzCmdDesc *cmd_info_trycatch_cd = rz_cmd_desc_argv_state_new(core->rcmd, i_cd, "iw", RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_JSON, rz_cmd_info_trycatch_handler, &cmd_info_trycatch_help);
	...
	RzCmdDesc *cmd_info_guess_size_cd = rz_cmd_desc_argv_state_new(core->rcmd, i_cd, "iZ", RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_STANDARD, rz_cmd_info_guess_size_handler, &cmd_info_guess_size_help);
	...
	RzCmdDesc *plugins_lang_print_cd = rz_cmd_desc_argv_state_new(core->rcmd, L_cd, "Ll", RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_plugins_lang_print_handler, &plugins_lang_print_help);
	rz_warn_if_fail(plugins_lang_print_cd);

	RzCmdDesc *La_cd = rz_cmd_desc_group_state_new(core->rcmd, L_cd, "La", RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_plugins_asm_print_handler, &plugins_asm_print_help, &La_help);
	rz_warn_if_fail(La_cd);
	RzCmdDesc *plugins_asm_cpu_print_cd = rz_cmd_desc_argv_state_new(core->rcmd, La_cd, "Lac", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_plugins_asm_cpu_print_handler, &plugins_asm_cpu_print_help);
	rz_warn_if_fail(plugins_asm_cpu_print_cd);

	RzCmdDesc *plugins_core_print_cd = rz_cmd_desc_argv_state_new(core->rcmd, L_cd, "Lc", RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_plugins_core_print_handler, &plugins_core_print_help);
	rz_warn_if_fail(plugins_core_print_cd);

	RzCmdDesc *plugins_crypto_print_cd = rz_cmd_desc_argv_state_new(core->rcmd, L_cd, "LC", RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_plugins_crypto_print_handler, &plugins_crypto_print_help);
	rz_warn_if_fail(plugins_crypto_print_cd);

	RzCmdDesc *plugins_debug_print_cd = rz_cmd_desc_argv_state_new(core->rcmd, L_cd, "Ld", RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_plugins_debug_print_handler, &plugins_debug_print_help);
	rz_warn_if_fail(plugins_debug_print_cd);

	RzCmdDesc *plugins_hash_print_cd = rz_cmd_desc_argv_state_new(core->rcmd, L_cd, "Lh", RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_plugins_hash_print_handler, &plugins_hash_print_help);
	rz_warn_if_fail(plugins_hash_print_cd);

	RzCmdDesc *plugins_bin_print_cd = rz_cmd_desc_argv_state_new(core->rcmd, L_cd, "Li", RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_plugins_bin_print_handler, &plugins_bin_print_help);
	rz_warn_if_fail(plugins_bin_print_cd);

	RzCmdDesc *plugins_io_print_cd = rz_cmd_desc_argv_state_new(core->rcmd, L_cd, "Lo", RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_plugins_io_print_handler, &plugins_io_print_help);
	rz_warn_if_fail(plugins_io_print_cd);

	RzCmdDesc *plugins_parser_print_cd = rz_cmd_desc_argv_state_new(core->rcmd, L_cd, "Lp", RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_plugins_parser_print_handler, &plugins_parser_print_help);
	rz_warn_if_fail(plugins_parser_print_cd);

	RzCmdDesc *plugins_demanglers_print_cd = rz_cmd_desc_argv_state_new(core->rcmd, L_cd, "LD", RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_plugins_demanglers_print_handler, &plugins_demanglers_print_help);
	...
	RzCmdDesc *pf_cd = rz_cmd_desc_group_state_new(core->rcmd, cmd_print_cd, "pf", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET, rz_cmd_print_format_handler, &cmd_print_format_help, &pf_help);
	...
	RzCmdDesc *cmd_print_format_named_dot_cd = rz_cmd_desc_argv_state_new(core->rcmd, pf_cd, "pf.", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET, rz_cmd_print_format_named_dot_handler, &cmd_print_format_named_dot_help);
	...
	RzCmdDesc *cmd_print_hash_cfg_algo_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, cmd_print_default_cd, "phl", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_TABLE | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET, rz_cmd_print_hash_cfg_algo_list_handler, &cmd_print_hash_cfg_algo_list_help);
	...
	RzCmdDesc *pv_cd = rz_cmd_desc_group_state_new(core->rcmd, cmd_print_cd, "pv", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_print_value_handler, &print_value_help, &pv_help);
	rz_warn_if_fail(pv_cd);
	RzCmdDesc *print_value1_cd = rz_cmd_desc_argv_state_new(core->rcmd, pv_cd, "pv1", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_print_value1_handler, &print_value1_help);
	rz_warn_if_fail(print_value1_cd);

	RzCmdDesc *print_value2_cd = rz_cmd_desc_argv_state_new(core->rcmd, pv_cd, "pv2", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_print_value2_handler, &print_value2_help);
	rz_warn_if_fail(print_value2_cd);

	RzCmdDesc *print_value4_cd = rz_cmd_desc_argv_state_new(core->rcmd, pv_cd, "pv4", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_print_value4_handler, &print_value4_help);
	rz_warn_if_fail(print_value4_cd);

	RzCmdDesc *print_value8_cd = rz_cmd_desc_argv_state_new(core->rcmd, pv_cd, "pv8", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_print_value8_handler, &print_value8_help);
	...
	RzCmdDesc *pxr_cd = rz_cmd_desc_group_state_new(core->rcmd, px_cd, "pxr", RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_TABLE, rz_print_hexword_references_handler, &print_hexword_references_help, &pxr_help);
	rz_warn_if_fail(pxr_cd);
	RzCmdDesc *print_hexword_references_1_cd = rz_cmd_desc_argv_state_new(core->rcmd, pxr_cd, "pxr1", RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_TABLE, rz_print_hexword_references_1_handler, &print_hexword_references_1_help);
	rz_warn_if_fail(print_hexword_references_1_cd);

	RzCmdDesc *print_hexword_references_2_cd = rz_cmd_desc_argv_state_new(core->rcmd, pxr_cd, "pxr2", RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_TABLE, rz_print_hexword_references_2_handler, &print_hexword_references_2_help);
	rz_warn_if_fail(print_hexword_references_2_cd);

	RzCmdDesc *print_hexword_references_4_cd = rz_cmd_desc_argv_state_new(core->rcmd, pxr_cd, "pxr4", RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_TABLE, rz_print_hexword_references_4_handler, &print_hexword_references_4_help);
	rz_warn_if_fail(print_hexword_references_4_cd);

	RzCmdDesc *print_hexword_references_8_cd = rz_cmd_desc_argv_state_new(core->rcmd, pxr_cd, "pxr8", RZ_OUTPUT_MODE_QUIET | RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_TABLE, rz_print_hexword_references_8_handler, &print_hexword_references_8_help);
	...
	RzCmdDesc *sh_cd = rz_cmd_desc_group_state_new(core->rcmd, s_cd, "sh", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_seek_history_list_handler, &seek_history_list_help, &sh_help);
	...
	RzCmdDesc *t_cd = rz_cmd_desc_group_modes_new(core->rcmd, root_cd, "t", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_LONG, rz_type_handler, &type_help, &t_help);
	...
	RzCmdDesc *tcc_cd = rz_cmd_desc_group_modes_new(core->rcmd, tc_cd, "tcc", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_LONG | RZ_OUTPUT_MODE_SDB | RZ_OUTPUT_MODE_JSON, rz_type_cc_list_handler, &type_cc_list_help, &tcc_help);
	...
	RzCmdDesc *interactive_visual_config_cd = rz_cmd_desc_argv_new(core->rcmd, V_cd, "Ve", rz_interactive_visual_config_handler, &interactive_visual_config_help);
	rz_warn_if_fail(interactive_visual_config_cd);

	RzCmdDesc *interactive_visual_graph_cd = rz_cmd_desc_argv_new(core->rcmd, V_cd, "VV", rz_interactive_visual_graph_handler, &interactive_visual_graph_help);
	rz_warn_if_fail(interactive_visual_graph_cd);
	...
	RzCmdDesc *wc_cd = rz_cmd_desc_group_state_new(core->rcmd, w_cd, "wc", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON, rz_write_cache_list_handler, &write_cache_list_help, &wc_help);
	...
	RzCmdDesc *write_pcache_list_cd = rz_cmd_desc_argv_state_new(core->rcmd, wc_cd, "wcp", RZ_OUTPUT_MODE_STANDARD, rz_write_pcache_list_handler, &write_pcache_list_help);
	...
	RzCmdDesc *print_hexdump_comments_alias_cd = rz_cmd_desc_argv_new(core->rcmd, root_cd, "xc", rz_print_hexdump_comments_alias_handler, &print_hexdump_comments_alias_help);
	rz_warn_if_fail(print_hexdump_comments_alias_cd);

	RzCmdDesc *y_cd = rz_cmd_desc_group_state_new(core->rcmd, root_cd, "y", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_QUIET, rz_yank_handler, &yank_help, &y_help);
