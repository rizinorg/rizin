	...
	case 'b': // "afb"
		...
		case 'i': // "afbi"
			...
			case 'j': {
				...
				rz_core_analysis_bb_info_print(core, bb, addr, input[3] == 'j' ? RZ_OUTPUT_MODE_JSON : RZ_OUTPUT_MODE_LONG);
				break;
			}
			default:
		...
		case '.': // "afb."
			...
			case '\0': {
				...
				rz_core_analysis_bb_info_print(core, bb, addr, input[3] == 'j' ? RZ_OUTPUT_MODE_JSON : RZ_OUTPUT_MODE_STANDARD);
				break;
			}
			default:
