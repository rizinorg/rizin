...
static void blake2b_increment_counter( blake2b_state *S, const ut64 inc ) {
  S->t[0] += inc;
  S->t[1] += ( S->t[0] < inc );
}
...
/* inlen, at least, should be ut64. Others can be size_t. */
int blake2b( void *out, size_t outlen, const void *in, size_t inlen, const void *key, size_t keylen )
{
  ...
  blake2b_update( S, ( const ut8 * )in, inlen );
