...
RZ_IPI struct state *get_state(void) {
...
RZ_IPI int get_operand(struct state *s, struct directive *d) {
...
RZ_IPI void xap_decode(struct state *s, struct directive *d) {
...
RZ_IPI struct directive *next_inst(struct state *s) {
	int rd;
