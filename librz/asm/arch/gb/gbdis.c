...
static void gb_hardware_register_name (char *reg, ut8 offset) {
	...
	case 0x48: // Object Palette 0 Data
		rz_str_cpy (reg, "rOBP0")
		break;
	case 0x49: // Object Palette 1 Data
		rz_str_cpy (reg, "rOBP1")
		break;
