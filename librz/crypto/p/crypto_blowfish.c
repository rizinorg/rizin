...
static const ut32 s[4][256] = { { 0xD1310BA6, 0x98DFB5AC, 0x2FFD72DB, 0xD01ADFB7, 0xB8E1AFED, 0x6A267E96, 0xBA7C9045, 0xF12C7F99,
...
static bool blowfish_init(struct blowfish_state *const state, const ut8 *key, int keylen) {
	...
	/* Subkeys are calculated in terms of user key.
	 * P0 is XORed with first 32 bits of key, P1 with next 32 bits, and so on.
