...
pyc_opcodes *opcode_311(void) {
	...
	// rm_op(.op_obj = ret->opcodes, .op_name = "BINARY_SUBSCR", .op_code = 25);
	...
	// def_op(.op_obj = ret->opcodes, .op_name = "PREP_RERAISE_STAR", .op_code = 88, .pop = 2, .push = 1);
	...
	// // jrel_op(.op_onj = ret->opcodes, .op_name = "JUMP_BACKWARD_NO_INTERRUPT", .op_code = 134, .pop = 0, .push = 0, .conditional = false);
	...
	// jrel_op(.op_obj = ret->opcodes, .op_name = "JUMP_BACKWARD", .conditional = false, .fallthrough = false);
