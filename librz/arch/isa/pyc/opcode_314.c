...
pyc_opcodes *opcode_314(void) {
    ...
    const_op(.op_obj = ret->opcodes, .op_name = "LOAD_COMMON_CONSTANT", .op_code = 81, .pop = 0, .push = 1);
    const_op(.op_obj = ret->opcodes, .op_name = "LOAD_CONST", .op_code = 82, .pop = 0, .push = 1);
    ...
    const_op(.op_obj = ret->opcodes, .op_name = "LOAD_CONST_IMMORTAL", .op_code = 190, .pop = 0, .push = 1); // oparg refers to an index in FRAME_CO_CONSTS
    const_op(.op_obj = ret->opcodes, .op_name = "LOAD_CONST_MORTAL", .op_code = 191, .pop = 0, .push = 1); // ""
    ...
    def_op(.op_obj = ret->opcodes, .op_name = "ANNOTATIONS_PLACEHOLDER", .op_code = 256, .pop = 0, .push = 0);
    jrel_op(.op_obj = ret->opcodes, .op_name = "JUMP", .op_code = 257, .pop = 0, .push = 0); // calls JUMPBY
    jrel_op(.op_obj = ret->opcodes, .op_name = "JUMP_IF_FALSE", .op_code = 258, .pop = 1, .push = 1, .conditional = true);
    jrel_op(.op_obj = ret->opcodes, .op_name = "JUMP_IF_TRUE", .op_code = 259, .pop = 1, .push = 1, .conditional = true);
    jrel_op(.op_obj = ret->opcodes, .op_name = "JUMP_NO_INTERRUPT", .op_code = 260, .pop = 0, .push = 0);
    local_op(.op_obj = ret->opcodes, .op_name = "LOAD_CLOSURE", .op_code = 261, .pop = 0, .push = 1);
    def_op(.op_obj = ret->opcodes, .op_name = "POP_BLOCK", .op_code = 262, .pop = 0, .push = 0);
    def_op(.op_obj = ret->opcodes, .op_name = "SETUP_CLEANUP", .op_code = 263, .pop = 0, .push = 2);
    def_op(.op_obj = ret->opcodes, .op_name = "SETUP_FINALLY", .op_code = 264, .pop = 0, .push = 1);
    def_op(.op_obj = ret->opcodes, .op_name = "SETUP_WITH", .op_code = 265, .pop = 0, .push = 1);
    store_op00(.op_obj = ret->opcodes, .op_name = "STORE_FAST_MAYBE_NULL", .op_code = 266, .pop = 1, .push = 0, .func = LOCAL_OP);
