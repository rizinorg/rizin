...
RzILOpEffect *hex_il_op_j4_cmpeq_f_jumpnv_nt(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *jump_op_ADD_14_15 = SEQ2(SETL("jump_flag", IL_TRUE), JMP(op_ADD_14));

	// seq(r; r = (r & -0x4); jump(pc + ((ut32) r)); {});
	RzILOpEffect *seq_then_17 = SEQN(3, op_ASSIGN_11, jump_op_ADD_14_15, EMPTY());
	...
	RzILOpEffect *instruction_sequence = SEQN(3, imm_assign_4, EMPTY(), branch_18);
...
RzILOpEffect *hex_il_op_j4_cmpeq_fp0_jump_nt_part0(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(2, op_ASSIGN_8, EMPTY());
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_j4_cmpeq_fp0_jump_nt_part1(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *jump_op_ADD_15_16 = SEQ2(SETL("jump_flag", IL_TRUE), JMP(op_ADD_15));

	// seq(r; r = (r & -0x4); jump(pc + ((ut32) r)); {});
	RzILOpEffect *seq_then_18 = SEQN(3, op_ASSIGN_12, jump_op_ADD_15_16, EMPTY());
...
RzILOpEffect *hex_il_op_j4_cmpeqi_f_jumpnv_nt(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *jump_op_ADD_16_17 = SEQ2(SETL("jump_flag", IL_TRUE), JMP(op_ADD_16));

	// seq(r; r = (r & -0x4); jump(pc + ((ut32) r)); {});
	RzILOpEffect *seq_then_19 = SEQN(3, op_ASSIGN_13, jump_op_ADD_16_17, EMPTY());
	...
	RzILOpEffect *instruction_sequence = SEQN(4, imm_assign_2, imm_assign_6, EMPTY(), branch_20);
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_j4_cmpeqn1_f_jumpnv_nt(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(3, imm_assign_5, EMPTY(), branch_19);
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_j4_cmpeqn1_fp0_jump_nt_part0(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(2, op_ASSIGN_9, EMPTY());
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_j4_cmpgti_f_jumpnv_nt(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *jump_op_ADD_17_18 = SEQ2(SETL("jump_flag", IL_TRUE), JMP(op_ADD_17));

	// seq(r; r = (r & -0x4); jump(pc + ((ut32) r)); {});
	RzILOpEffect *seq_then_20 = SEQN(3, op_ASSIGN_14, jump_op_ADD_17_18, EMPTY());
	...
	RzILOpEffect *instruction_sequence = SEQN(4, imm_assign_2, imm_assign_7, EMPTY(), branch_21);
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_j4_cmpgtn1_f_jumpnv_nt(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(3, imm_assign_6, EMPTY(), branch_20);
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_j4_cmpgtu_f_jumpnv_nt(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(3, imm_assign_7, EMPTY(), branch_21);
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_j4_cmpgtu_fp0_jump_nt_part0(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(2, op_ASSIGN_10, EMPTY());
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_j4_cmpgtui_f_jumpnv_nt(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(4, imm_assign_3, imm_assign_7, EMPTY(), branch_21);
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_j4_cmpgtui_fp0_jump_nt_part0(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(3, imm_assign_3, op_ASSIGN_10, EMPTY());
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_j4_cmpgtui_t_jumpnv_nt(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(4, imm_assign_3, imm_assign_6, EMPTY(), branch_20);
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_j4_hintjumpr(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(2, EMPTY(), EMPTY());
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_j4_jumpseti(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(6, imm_assign_0, imm_assign_9, op_ASSIGN_7, op_ASSIGN_12, jump_op_ADD_15_16, EMPTY());
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_j4_jumpsetr(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *jump_op_ADD_13_14 = SEQ2(SETL("jump_flag", IL_TRUE), JMP(op_ADD_13));

	RzILOpEffect *instruction_sequence = SEQN(5, imm_assign_0, op_ASSIGN_7, op_ASSIGN_10, jump_op_ADD_13_14, EMPTY());
	return instruction_sequence;
}
