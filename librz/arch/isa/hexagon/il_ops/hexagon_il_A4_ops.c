...
RzILOpEffect *hex_il_op_a4_bitsplit(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(5, op_ASSIGN_10, op_ASSIGN_31, EMPTY(), op_ASSIGN_60, EMPTY());
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_a4_bitspliti(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(5, imm_assign_10, op_ASSIGN_21, EMPTY(), op_ASSIGN_50, EMPTY());
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_a4_combineii(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(6, imm_assign_0, imm_assign_27, op_ASSIGN_18, EMPTY(), op_ASSIGN_37, EMPTY());
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_a4_combineir(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(5, imm_assign_0, op_ASSIGN_19, EMPTY(), op_ASSIGN_36, EMPTY());
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_a4_combineri(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(5, imm_assign_0, op_ASSIGN_18, EMPTY(), op_ASSIGN_36, EMPTY());
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_a4_vcmpbeqi(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *seq_34 = SEQN(2, op_ASSIGN_32, EMPTY());
...
RzILOpEffect *hex_il_op_a4_vcmpheqi(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *seq_67 = SEQN(4, op_ASSIGN_36, EMPTY(), op_ASSIGN_65, EMPTY());
...
RzILOpEffect *hex_il_op_a4_vrmaxh(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(7, op_ASSIGN_13, op_ASSIGN_23, seq_61, op_ASSIGN_76, EMPTY(), op_ASSIGN_93, EMPTY());
	return instruction_sequence;
}
...
RzILOpEffect *hex_il_op_a4_vrmaxw(HexInsnPktBundle *bundle) {
	...
	RzILOpEffect *instruction_sequence = SEQN(7, op_ASSIGN_12, op_ASSIGN_22, seq_58, op_ASSIGN_73, EMPTY(), op_ASSIGN_90, EMPTY());
	return instruction_sequence;
}
