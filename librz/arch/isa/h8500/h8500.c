...
static const H8500EADescribe h8500_eas[] = {
	...
	{ AddrRIDisp, "@(d:8" SEP "Rn)", { H(0b1110) | Sz | Rrr, Disp8, END }, 8, 2 },
	{ AddrRIDisp, "@(d:16" SEP "Rn)", { H(0b1111) | Sz | Rrr, Placeholder, Disp16, END }, 16, 3 },
...
static const H8500OpcodeDescribe h8500_opcodes[] = {
	{ ADD_Q, "add:q.<Sz>", "<EA>" SEP "Rn", 1, { HR(0b00100), END }, { EA, AddrREG } },
	{ ADD_Q, "add:q.<Sz>", "#1" SEP "<EA>", 1, { B(0b00001000), END }, { ARG_PACK_DATA(1) | AddrIMM, EA }, EA_BanIMM },
	{ ADD_Q, "add:q.<Sz>", "#2" SEP "<EA>", 1, { B(0b00001001), END }, { ARG_PACK_DATA(2) | AddrIMM, EA }, EA_BanIMM },
	{ ADD_Q, "add:q.<Sz>", "#-1" SEP "<EA>", 1, { B(0b00001100), END }, { ARG_PACK_DATA(1) | AddrIMM, EA }, EA_BanIMM },
	{ ADD_Q, "add:q.<Sz>", "#-2" SEP "<EA>", 1, { B(0b00001101), END }, { ARG_PACK_DATA(2) | AddrIMM, EA }, EA_BanIMM },
	{ ADDS, "adds.<Sz>", "<EA>" SEP "Rn", 1, { HR(0b00101), END }, { EA, AddrREG } },
	{ ADDX, "addx.<Sz>", "<EA>" SEP "Rn", 1, { HR(0b10100), END }, { EA, AddrREG } },
	{ AND, "and.<Sz>", "<EA>" SEP "Rn", 1, { HR(0b01010), END }, { EA, AddrREG } },
	{ BCLR, "bclr.<Sz>", "#xx" SEP "<EA>", 1, { H(0b1101) | Data4Op, END }, { AddrIMM, EA }, EA_BanIMM },
	{ BCLR, "bclr.<Sz>", "Rn" SEP "<EA>", 1, { HR(0b01011), END }, { AddrREG, EA }, EA_BanIMM },
	{ BNOT, "bnot.<Sz>", "#xx" SEP "<EA>", 1, { H(0b1110) | Data4Op, END }, { AddrIMM, EA }, EA_BanIMM },
	{ BNOT, "bnot.<Sz>", "Rn" SEP "<EA>", 1, { HR(0b01101), END }, { AddrREG, EA }, EA_BanIMM },
	{ BSET, "bset.<Sz>", "#xx" SEP "<EA>", 1, { H(0b1100) | Data4Op, END }, { AddrIMM, EA }, EA_BanIMM },
	{ BSET, "bset.<Sz>", "Rn" SEP "<EA>", 1, { HR(0b01001), END }, { AddrREG, EA }, EA_BanIMM },
	{ BTST, "btst.<Sz>", "#xx" SEP "<EA>", 1, { H(0b1111) | Data4Op, END }, { AddrIMM, EA }, EA_BanIMM },
	{ BTST, "btst.<Sz>", "Rn" SEP "<EA>", 1, { HR(0b01111), END }, { AddrREG, EA }, EA_BanIMM },

	{ CLR, "clr.<Sz>", "<EA>", 1, { B(0b00010011), END }, { EA }, EA_BanIMM },
	{ CMP, "cmp:g.<Sz>", "#xx" SEP "<EA>", 2, { B(0b00000100), Data8Op, END }, { AddrIMM, EA }, EA_BanIMM },
	{ CMP, "cmp:g.<Sz>", "#xx" SEP "<EA>", 3, { B(0b00000101), Data16Op, END }, { AddrIMM, EA }, EA_BanIMM },
	{ CMP, "cmp:g.<Sz>", "<EA>" SEP "Rn", 1, { HR(0b01110), END }, { EA, AddrREG } },
	{ DIVXU, "divxu.<Sz>", "<EA>" SEP "Rn", 1, { HR(0b10111), END }, { EA, AddrREG } },
	{ LDC, "ldc.<Sz>", "<EA>" SEP "CR", 1, { HC(0b10001), END }, { EA, AddrREGcr } },
	{ MOV, "mov:g.<Sz>", "<EA>" SEP "Rn", 1, { HR(0b10000), END }, { EA, AddrREG } },
	{ MOV, "mov:g.<Sz>", "Rn" SEP "<EA>", 1, { HR(0b10010), END }, { AddrREG, EA }, EA_BanIMM },
	...
	{ MOVFPE, "movfpe", "<EA>" SEP "Rn", 2, { B(0x00), HR(0b10000), END }, { EA, AddrREG }, EA_BanIMM },
	{ MOVTPE, "movtpe", "Rn" SEP "<EA>", 2, { B(0x00), HR(0b10010), END }, { AddrREG, EA }, EA_BanIMM },
	{ MULXU, "mulxu.<Sz>", "<EA>" SEP "Rn", 1, { HR(0b10101), END }, { EA, AddrREG } },
	{ NEG, "neg.<Sz>", "<EA>", 1, { B(0x14), END }, { EA }, EA_BanIMM },
	{ NOT, "not.<Sz>", "<EA>", 1, { B(0x15), END }, { EA }, EA_BanIMM },
	{ OR, "or.<Sz>", "<EA>" SEP "Rn", 1, { HR(0b01000), END }, { EA, AddrREG } },
	...
	{ STC, "stc.<Sz>", "CR" SEP "<EA>", 1, { HC(0b10011), END }, { AddrREGcr, EA }, EA_BanIMM },
	{ SUB, "sub.<Sz>", "<EA>" SEP "Rn", 1, { HR(0b00110), END }, { EA, AddrREG } },
	{ SUBS, "subs.<Sz>", "<EA>" SEP "Rn", 1, { HR(0b00111), END }, { EA, AddrREG } },
	{ SUBX, "subx.<Sz>", "<EA>" SEP "Rn", 1, { HR(0b10110), END }, { EA, AddrREG } },
	{ TAS, "tas", "<EA>", 1, { B(0x17), END }, { EA }, EA_BanIMM },
	{ TST, "tst", "<EA>", 1, { B(0x16), END }, { EA }, EA_BanIMM },
	{ XOR, "xor", "<EA>" SEP "Rn", 1, { HR(0b01100), END }, { EA, AddrREG } },
};

static const H8500OpcodeDescribe h8500_opcodes_without_ea[] = {
	{ ANDC, "andc.<Sz>", "#xx:8" SEP "CR", 3, { B(0x04), Data8Op, HC(0b01011), END }, { AddrIMM, AddrREGcr } },
	{ ANDC, "andc.<Sz>", "#xx:16" SEP "CR", 4, { B(0x0c), Data16Op, HC(0b01011), END }, { AddrIMM, AddrREGcr } },
	...
	{ DADD, "dadd", "Rn" SEP "Rn", 3, { HR(0b10100), B(0x00), HR(0b10100), END }, { AddrREG, AddrREG } },
	{ DSUB, "dsub", "Rn" SEP "Rn", 3, { HR(0b10100), B(0x00), HR(0b10110), END }, { AddrREG, AddrREG } },
	...
	{ JMP, "jmp", "@(d:8" SEP "Rn)", 3, { B(0x11), HRD8(0b11100), END }, { AddrRIDisp } },
	{ JMP, "jmp", "@(d:16" SEP "Rn)", 4, { B(0x11), HRD16(0b11110), END }, { AddrRIDisp } },
	{ JMP, "jmp", "@aa:16", 3, { B(0x10), AA16Op, END }, { AddrAbs } },
	{ JSR, "jsr", "@Rn", 2, { B(0x11), HR(0b11011), END }, { AddrRI } },
	{ JSR, "jsr", "@(d:8" SEP "Rn)", 3, { B(0x11), HRD8(0b11101), END }, { AddrRIDisp } },
	{ JSR, "jsr", "@(d:16" SEP "Rn)", 4, { B(0x11), HRD16(0b11111), END }, { AddrRIDisp } },
	...
	{ MOV, "mov:e", "#xx:8" SEP "Rn", 2, { HR(0b01010) | IDX(1), Data8Op | IDX(0), END }, { AddrIMM, AddrREG } },
	{ MOV, "mov:f.<Sz>", "@(d:8" SEP "Rn)" SEP "Rn", 2, { HSR(0b1000) | IDX(1), Disp8Op | ImpliedR6 | IDX(0), END }, { AddrRIDisp, AddrREG } },
	{ MOV, "mov:f.<Sz>", "Rn" SEP "@(d:8" SEP "Rn)", 2, { HSR(0b1001), Disp8Op | ImpliedR6, END }, { AddrREG, AddrRIDisp } },
	{ MOV, "mov:i", "#xx:16" SEP "Rn", 3, { HR(0b01011) | IDX(1), Data16Op | IDX(0), END }, { AddrIMM, AddrREG } },
	{ MOV, "mov:l.<Sz>", "@aa:8" SEP "Rn", 2, { HSR(0b0110) | IDX(1), AA8Op | IDX(0), END }, { AddrAbs, AddrREG } },
	{ MOV, "mov:s.<Sz>", "Rn" SEP "@aa:8", 2, { HSR(0b0111), AA8Op, END }, { AddrREG, AddrAbs } },
	{ NOP, "nop", "", 1, { B(0x00), END }, { 0 } },
	{ ORC, "orc.<Sz>", "#xx:8" SEP "CR", 3, { B(0x04), Data8Op, HC(0b01001), END }, { AddrIMM, AddrREGcr } },
	{ ORC, "orc.<Sz>", "#xx:16" SEP "CR", 4, { B(0x0c), Data16Op, HC(0b01001), END }, { AddrIMM, AddrREGcr } },
	...
	{ SCB_F, "scb/f", "Rn" SEP "disp", 3, { B(0x01), HR(0b10111), Disp8Op, END }, { AddrREG, AddrPCRel } },
	{ SCB_NE, "scb/ne", "Rn" SEP "disp", 3, { B(0x06), HR(0b10111), Disp8Op, END }, { AddrREG, AddrPCRel } },
	{ SCB_EQ, "scb/eq", "Rn" SEP "disp", 3, { B(0x07), HR(0b10111), Disp8Op, END }, { AddrREG, AddrPCRel } },
	...
	{ XCH, "xch", "Rn" SEP "Rn", 2, { HR(0b10101), HR(0b10010), END }, { AddrREG, AddrREG } },
	{ XORC, "xorc.<Sz>", "#xx:8" SEP "CR", 3, { B(0x04), Data8Op, HC(0b01101), END }, { AddrIMM, AddrREGcr } },
	{ XORC, "xorc.<Sz>", "#xx:16" SEP "CR", 4, { B(0x0c), Data16Op, HC(0b01101), END }, { AddrIMM, AddrREGcr } },
