...
DEFINE_LIFTER(auipc, DECODE_RD_IMM, ADD(UN(analysis->bits, current_addr), SIGNED(analysis->bits, SHIFTL0(CAST(32, IL_FALSE, imm), UN(32, 12)))))
...
TWICE_FOR(fence, fence_i,
	DEFINE_LIFTER_WITH_EFFECT, DECODE_NONE, NOP())
...
// System: environment call (trap to OS / hypervisor)
