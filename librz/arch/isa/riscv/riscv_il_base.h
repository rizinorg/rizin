...
#define RISCV_GET_REG(reg)    (((reg) != RISCV_REG_X0) ? (VARG(riscv_integer_reg_name(reg))) : UN(analysis->bits, 0))
#define RISCV_SET_REG(reg, r) (((reg) != RISCV_REG_X0) ? (SETG(riscv_integer_reg_name(reg), r)) : ((rz_il_op_pure_free(r), NOP())))
