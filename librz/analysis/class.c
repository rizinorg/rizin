...
static void rz_analysis_class_base_delete_class(RzAnalysis *anal, const char *class_name);
static void rz_analysis_class_method_delete_class(RzAnalysis *anal, const char *class_name);
static void rz_analysis_class_vtable_delete_class(RzAnalysis *anal, const char *class_name);
static void rz_analysis_class_base_rename_class(RzAnalysis *anal, const char *class_name_old, const char *class_name_new);
static void rz_analysis_class_method_rename_class(RzAnalysis *anal, const char *old_class_name, const char *new_class_name);
static void rz_analysis_class_vtable_rename_class(RzAnalysis *anal, const char *old_class_name, const char *new_class_name);
...
RZ_API void rz_analysis_class_delete(RzAnalysis *anal, const char *name) {
	...
	rz_analysis_class_base_delete_class (anal, class_name_sanitized);
	rz_analysis_class_method_delete_class (anal, class_name_sanitized);
	rz_analysis_class_vtable_delete_class (anal, class_name_sanitized);
...
static bool rz_analysis_class_exists_raw(RzAnalysis *anal, const char *name) {
...
RZ_API bool rz_analysis_class_exists(RzAnalysis *anal, const char *name) {
	...
	bool r = rz_analysis_class_exists_raw (anal, class_name_sanitized);
	free (class_name_sanitized);
	return r;
}
...
RZ_API RzAnalysisClassErr rz_analysis_class_rename(RzAnalysis *anal, const char *old_name, const char *new_name) {
	if (rz_analysis_class_exists (anal, new_name)) {
	...
	rz_analysis_class_base_rename_class (anal, old_name, new_name);
	rz_analysis_class_method_rename_class (anal, old_name, new_name);
	rz_analysis_class_vtable_rename_class (anal, old_name, new_name);
...
static char *rz_analysis_class_get_attr_raw(RzAnalysis *anal, const char *class_name, RzAnalysisClassAttrType attr_type, const char *attr_id, bool specific) {
...
static char *rz_analysis_class_get_attr(RzAnalysis *anal, const char *class_name, RzAnalysisClassAttrType attr_type, const char *attr_id, bool specific) {
	...
	char *ret = rz_analysis_class_get_attr_raw (anal, class_name_sanitized, attr_type, attr_id_sanitized, specific);
...
// all ids must be sanitized
static RzAnalysisClassErr rz_analysis_class_set_attr_raw(RzAnalysis *anal, const char *class_name, RzAnalysisClassAttrType attr_type, const char *attr_id, const char *content) {
	const char *attr_type_str = attr_type_id (attr_type);

	if (!rz_analysis_class_exists_raw (anal, class_name)) {
...
// ids will be sanitized automatically
static RzAnalysisClassErr rz_analysis_class_set_attr(RzAnalysis *anal, const char *class_name, RzAnalysisClassAttrType attr_type, const char *attr_id, const char *content) {
	char *class_name_sanitized = rz_str_sanitize_sdb_key (class_name);
	if (!class_name_sanitized) {
		return RZ_ANAL_CLASS_ERR_OTHER;
	}
	...
	RzAnalysisClassErr err = rz_analysis_class_set_attr_raw (anal, class_name_sanitized, attr_type, attr_id_sanitized, content);
...
static RzAnalysisClassErr rz_analysis_class_delete_attr_raw(RzAnalysis *anal, const char *class_name, RzAnalysisClassAttrType attr_type, const char *attr_id) {
	const char *attr_type_str = attr_type_id (attr_type);
...
static RzAnalysisClassErr rz_analysis_class_delete_attr(RzAnalysis *anal, const char *class_name, RzAnalysisClassAttrType attr_type, const char *attr_id) {
	char *class_name_sanitized = rz_str_sanitize_sdb_key (class_name);
	if (!class_name_sanitized) {
		return RZ_ANAL_CLASS_ERR_OTHER;
	}
	...
	RzAnalysisClassErr err = rz_analysis_class_delete_attr_raw (anal, class_name_sanitized, attr_type, attr_id_sanitized);
...
static RzAnalysisClassErr rz_analysis_class_rename_attr_raw(RzAnalysis *anal, const char *class_name, RzAnalysisClassAttrType attr_type, const char *attr_id_old, const char *attr_id_new) {
	const char *attr_type_str = attr_type_id (attr_type);
...
static RzAnalysisClassErr rz_analysis_class_rename_attr(RzAnalysis *anal, const char *class_name, RzAnalysisClassAttrType attr_type, const char *attr_id_old, const char *attr_id_new) {
	char *class_name_sanitized = rz_str_sanitize_sdb_key (class_name);
	if (!class_name_sanitized) {
		return RZ_ANAL_CLASS_ERR_OTHER;
	}
	...
	RzAnalysisClassErr ret = rz_analysis_class_rename_attr_raw (anal, class_name_sanitized, attr_type, attr_id_old_sanitized, attr_id_new_sanitized);
	free (class_name_sanitized);
	free (attr_id_old_sanitized);
...
static void rz_analysis_class_unique_attr_id_raw(RzAnalysis *anal, const char *class_name, RzAnalysisClassAttrType attr_type, char *out, size_t out_size) {
	ut64 id = 0;
...
static void rz_analysis_class_set_flag(RzAnalysis *anal, const char *name, ut64 addr, ut32 size) {
...
static void rz_analysis_class_unset_flag(RzAnalysis *anal, const char *name) {
...
static void rz_analysis_class_rename_flag(RzAnalysis *anal, const char *old_name, const char *new_name) {
...
static RzAnalysisClassErr rz_analysis_class_add_attr_unique_raw(RzAnalysis *anal, const char *class_name, RzAnalysisClassAttrType attr_type, const char *content, char *attr_id_out, size_t attr_id_out_size) {
	char attr_id[16];
	rz_analysis_class_unique_attr_id_raw (anal, class_name, attr_type, attr_id, sizeof(attr_id));

	RzAnalysisClassErr err = rz_analysis_class_set_attr (anal, class_name, attr_type, attr_id, content);
...
static RzAnalysisClassErr rz_analysis_class_add_attr_unique(RzAnalysis *anal, const char *class_name, RzAnalysisClassAttrType attr_type, const char *content, char *attr_id_out, size_t attr_id_out_size) {
	char *class_name_sanitized = rz_str_sanitize_sdb_key (class_name);
	if (!class_name_sanitized) {
		return RZ_ANAL_CLASS_ERR_OTHER;
	}

	RzAnalysisClassErr err = rz_analysis_class_add_attr_unique_raw (anal, class_name_sanitized, attr_type, content, attr_id_out, attr_id_out_size);
...
RZ_API RzAnalysisClassErr rz_analysis_class_method_get(RzAnalysis *anal, const char *class_name, const char *meth_name, RzAnalysisMethod *meth) {
	char *content = rz_analysis_class_get_attr (anal, class_name, RZ_ANAL_CLASS_ATTR_TYPE_METHOD, meth_name, false);
	if (!content) {
		return RZ_ANAL_CLASS_ERR_NONEXISTENT_ATTR;
	}
...
RZ_API RzVector/*<RzAnalysisMethod>*/ *rz_analysis_class_method_get_all(RzAnalysis *anal, const char *class_name) {
	...
	sdb_aforeach (cur, array) {
		...
		if (rz_analysis_class_method_get (anal, class_name, cur, &meth) == RZ_ANAL_CLASS_ERR_SUCCESS) {
...
RZ_API RzAnalysisClassErr rz_analysis_class_method_set(RzAnalysis *anal, const char *class_name, RzAnalysisMethod *meth) {
	...
	RzAnalysisClassErr err = rz_analysis_class_set_attr (anal, class_name, RZ_ANAL_CLASS_ATTR_TYPE_METHOD, meth->name, content);
	if (err != RZ_ANAL_CLASS_ERR_SUCCESS) {
		return err;
	}
	rz_analysis_class_set_flag (anal, flagname_method (class_name, meth->name), meth->addr, 0);
	return RZ_ANAL_CLASS_ERR_SUCCESS;
}
...
RZ_API RzAnalysisClassErr rz_analysis_class_method_rename(RzAnalysis *anal, const char *class_name, const char *old_meth_name, const char *new_meth_name) {
	RzAnalysisClassErr err = rz_analysis_class_rename_attr (anal, class_name, RZ_ANAL_CLASS_ATTR_TYPE_METHOD, old_meth_name, new_meth_name);
	if (err != RZ_ANAL_CLASS_ERR_SUCCESS) {
		return err;
	}
	rz_analysis_class_rename_flag (anal,
...
static void rz_analysis_class_method_delete_class(RzAnalysis *anal, const char *class_name) {
	...
	char *cur;
	sdb_aforeach (cur, array) {
		rz_analysis_class_unset_flag (anal, flagname_method (class_name, cur));
		sdb_aforeach_next (cur);
	}
	free (array);
}
...
RZ_API RzAnalysisClassErr rz_analysis_class_method_delete(RzAnalysis *anal, const char *class_name, const char *meth_name) {
	...
	RzAnalysisClassErr err = rz_analysis_class_delete_attr_raw (anal, class_name_sanitized, RZ_ANAL_CLASS_ATTR_TYPE_METHOD, meth_name_sanitized);
	if (err == RZ_ANAL_CLASS_ERR_SUCCESS) {
		rz_analysis_class_unset_flag (anal, flagname_method (class_name_sanitized, meth_name_sanitized));
	}
	free (class_name_sanitized);
...
RZ_API RzAnalysisClassErr rz_analysis_class_base_get(RzAnalysis *anal, const char *class_name, const char *base_id, RzAnalysisBaseClass *base) {
	char *content = rz_analysis_class_get_attr (anal, class_name, RZ_ANAL_CLASS_ATTR_TYPE_BASE, base_id, false);
	if (!content) {
		return RZ_ANAL_CLASS_ERR_NONEXISTENT_ATTR;
	}
...
RZ_API RzVector/*<RzAnalysisBaseClass>*/ *rz_analysis_class_base_get_all(RzAnalysis *anal, const char *class_name) {
	...
	sdb_aforeach (cur, array) {
		...
		if (rz_analysis_class_base_get (anal, class_name, cur, &base) == RZ_ANAL_CLASS_ERR_SUCCESS) {
...
static RzAnalysisClassErr rz_analysis_class_base_set_raw(RzAnalysis *anal, const char *class_name, RzAnalysisBaseClass *base, const char *base_class_name_sanitized) {
	char *content = sdb_fmt ("%s" SDB_SS "%"PFMT64u, base_class_name_sanitized, base->offset);
	RzAnalysisClassErr err;
	if (base->id) {
		err = rz_analysis_class_set_attr (anal, class_name, RZ_ANAL_CLASS_ATTR_TYPE_BASE, base->id, content);
	} else {
		base->id = malloc(16);
		if (base->id) {
			err = rz_analysis_class_add_attr_unique (anal, class_name, RZ_ANAL_CLASS_ATTR_TYPE_BASE, content, base->id, 16);
		} else {
...
RZ_API RzAnalysisClassErr rz_analysis_class_base_set(RzAnalysis *anal, const char *class_name, RzAnalysisBaseClass *base) {
	...
	if (!rz_analysis_class_exists_raw (anal, base_class_name_sanitized)) {
		free (base_class_name_sanitized);
		return RZ_ANAL_CLASS_ERR_NONEXISTENT_CLASS;
	}
	RzVector /*<RzAnalysisBaseClass>*/ *bases = rz_analysis_class_base_get_all (anal, class_name);
	if (bases) {
	...
	RzAnalysisClassErr err = rz_analysis_class_base_set_raw (anal, class_name, base, base_class_name_sanitized);
	free (base_class_name_sanitized);
	rz_vector_free (bases);
	return err;
}
...
RZ_API RzAnalysisClassErr rz_analysis_class_base_delete(RzAnalysis *anal, const char *class_name, const char *base_id) {
	return rz_analysis_class_delete_attr (anal, class_name, RZ_ANAL_CLASS_ATTR_TYPE_BASE, base_id);
}
...
static bool rz_analysis_class_base_delete_class_cb(void *user, const char *k, const char *v) {
	...
	RzVector *bases = rz_analysis_class_base_get_all (ctx->anal, k);
	RzAnalysisBaseClass *base;
	rz_vector_foreach (bases, base) {
		if (base->class_name && strcmp (base->class_name, ctx->class_name) == 0) {
			rz_analysis_class_base_delete (ctx->anal, k, base->id);
		}
	}
	rz_vector_free (bases);
	return true;
...
static void rz_analysis_class_base_delete_class(RzAnalysis *anal, const char *class_name) {
	...
	rz_analysis_class_foreach (anal, rz_analysis_class_base_delete_class_cb, &ctx);
}
...
static bool rz_analysis_class_base_rename_class_cb(void *user, const char *k, const char *v) {
	...
	rz_vector_foreach (bases, base) {
		if (base->class_name && strcmp (base->class_name, ctx->class_name_old) == 0) {
			rz_analysis_class_base_set_raw (ctx->anal, k, base, ctx->class_name_new);
		}
	}
	rz_vector_free (bases);
	return 1;
...
static void rz_analysis_class_base_rename_class(RzAnalysis *anal, const char *class_name_old, const char *class_name_new) {
	...
	rz_analysis_class_foreach (anal, rz_analysis_class_base_rename_class_cb, &ctx);
}
...
RZ_API RzAnalysisClassErr rz_analysis_class_vtable_get(RzAnalysis *anal, const char *class_name, const char *vtable_id, RzAnalysisVTable *vtable) {
	char *content = rz_analysis_class_get_attr (anal, class_name, RZ_ANAL_CLASS_ATTR_TYPE_VTABLE, vtable_id, false);
	if (!content) {
		return RZ_ANAL_CLASS_ERR_NONEXISTENT_ATTR;
	}
...
RZ_API RzVector/*<RzAnalysisVTable>*/ *rz_analysis_class_vtable_get_all(RzAnalysis *anal, const char *class_name) {
	...
	sdb_aforeach (cur, array) {
		...
		if (rz_analysis_class_vtable_get (anal, class_name, cur, &vtable) == RZ_ANAL_CLASS_ERR_SUCCESS) {
...
RZ_API RzAnalysisClassErr rz_analysis_class_vtable_set(RzAnalysis *anal, const char *class_name, RzAnalysisVTable *vtable) {
	...
	if (vtable->id) {
		return rz_analysis_class_set_attr (anal, class_name, RZ_ANAL_CLASS_ATTR_TYPE_VTABLE, vtable->id, content);
	}
	vtable->id = malloc(16);
	if (!vtable->id) {
		return RZ_ANAL_CLASS_ERR_OTHER;
	}
	RzAnalysisClassErr err = rz_analysis_class_add_attr_unique (anal, class_name, RZ_ANAL_CLASS_ATTR_TYPE_VTABLE, content, vtable->id, 16);
	if (err != RZ_ANAL_CLASS_ERR_SUCCESS) {
		return err;
	}

	rz_analysis_class_set_flag (anal, flagname_vtable (class_name, vtable->id), vtable->addr, vtable->size);
...
static void rz_analysis_class_vtable_delete_class(RzAnalysis *anal, const char *class_name) {
	...
	char *cur;
	sdb_aforeach (cur, array) {
		rz_analysis_class_unset_flag (anal, flagname_vtable (class_name, cur));
		sdb_aforeach_next (cur);
	}
	free (array);
}
...
RZ_API RzAnalysisClassErr rz_analysis_class_vtable_delete(RzAnalysis *anal, const char *class_name, const char *vtable_id) {
	...
	RzAnalysisClassErr err = rz_analysis_class_delete_attr_raw (anal, class_name_sanitized, RZ_ANAL_CLASS_ATTR_TYPE_VTABLE, vtable_id_sanitized);
	if (err == RZ_ANAL_CLASS_ERR_SUCCESS) {
		rz_analysis_class_unset_flag (anal, flagname_vtable (class_name_sanitized, vtable_id_sanitized));
	}
	free (class_name_sanitized);
...
static void rz_analysis_class_print_cmd(RzAnalysis *anal, const char *class_name) {
	RzVector *bases = rz_analysis_class_base_get_all (anal, class_name);
	if (bases) {
		RzAnalysisBaseClass *base;
		rz_vector_foreach (bases, base) {
...
static bool rz_analysis_class_list_json_cb(void *user, const char *k, const char *v) {
	...
	rz_analysis_class_json (ctx->anal, ctx->j, k);
	return true;
}

static void rz_analysis_class_list_json(RzAnalysis *anal) {
	...
	ctx.anal = anal;
	ctx.j = j;
	rz_analysis_class_foreach (anal, rz_analysis_class_list_json_cb, &ctx);
...
RZ_API void rz_analysis_class_list(RzAnalysis *anal, int mode) {
	if (mode == 'j') {
		rz_analysis_class_list_json (anal);
		return;
	}

	SdbList *classes = rz_analysis_class_get_all (anal, mode != '*');
	SdbListIter *iter;
	SdbKv *kv;
	if (mode == '*') {
		...
		ls_foreach (classes, iter, kv) {
			rz_analysis_class_print_cmd(anal, sdbkv_key (kv));
		}
	} else {
		ls_foreach (classes, iter, kv) {
			rz_analysis_class_print (anal, sdbkv_key (kv), mode == 'l');
		}
	}
	ls_free (classes);
}
...
RZ_API void rz_analysis_class_list_bases(RzAnalysis *anal, const char *class_name) {
	...
	if (!rz_analysis_class_exists_raw (anal, class_name_sanitized)) {
		free (class_name_sanitized);
		return;
	}
...
static void list_all_functions_at_vtable_offset(RzAnalysis *anal, const char *class_name, ut64 offset) {
	...
	rz_analysis_vtable_begin (anal, &vtableContext);
...
RZ_API void rz_analysis_class_list_vtable_offset_functions(RzAnalysis *anal, const char *class_name, ut64 offset) {
	if (class_name) {
		...
		SdbList *classes = rz_analysis_class_get_all (anal, true);
		SdbListIter *iter;
		SdbKv *kv;
		ls_foreach (classes, iter, kv) {
 ...
 */
RZ_API RzGraph *rz_analysis_class_get_inheritance_graph(RzAnalysis *anal) {
	...
	ls_foreach (classes, iter, kv) {
		...
		RzVector *bases = rz_analysis_class_base_get_all (anal, name);
		RzAnalysisBaseClass *base;
		rz_vector_foreach (bases, base) {
