...
static char *get_reg_profile(RzAnalysis *analysis) {
	...
	p =
		...
		// Floating point registers (subset of vector scalar registers if implemented)
		"fpu	f0	.64 2048	0\n"
		"fpu	f1	.64 2176	0\n"
		"fpu	f2	.64 2304	0\n"
		"fpu	f3	.64 2432	0\n"
		...
		// Vector registers (subset of vector scalar registers)
		"vc	v0	.128 6144	0\n"
		"vc	v1	.128 6272	0\n"
		"vc	v2	.128 6400	0\n"
		"vc	v3	.128 6528	0\n"
		...
		"ctr	ebbhr .64	11008	0	# Event-Based Branch Handler Register\n"
		"ctr	ebbrr .64	11072	0	# Event-Based Branch Return Register\n"
		"ctr	lpcr	.64	11136	0	# Logical Partitioning Control Register\n"
		"ctr	hrmor .64	11200	0	# Hypervisor Real Mode Offset Register\n"
		// 0 |---/32/---|--lpidr--| 63
		"ctr	lpidr .32	11296	0	# Logical Partition Identification Regiser\n"
		"ctr	pcr	.64	11328	0	# Processor Compatibility Register\n"
		"ctr	tir	.64	11392	0	# Thread Identification Register\n"
		"ctr	urmor .64	11456	0	# Ultravisor Real Mode Offset Register\n"
		"ctr	smfctrl	.64	11520	0	# Secure Memory Facility Control Register\n"
		"ctr	msr	.64	11584	0	# Machine State Register\n"
		// 0 |---/32/---|---pvr---| 63
