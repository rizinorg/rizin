...
bool test_r_anal_var() {
	...
	RzAnalysisVar *a = rz_analysis_function_set_var (fcn, -8, RZ_ANAL_VAR_KIND_BPV, "char *", 8, false, "random_name");
	...
	RzAnalysisVar *b = rz_analysis_function_set_var (fcn, -0x10, RZ_ANAL_VAR_KIND_SPV, "char *", 8, false, "var_a");
	mu_assert_null (b, "create a var with the same name");
	b = rz_analysis_function_set_var (fcn, -0x10, RZ_ANAL_VAR_KIND_SPV, "char *", 8, false, "new_var");
	...
	RzAnalysisVar *c = rz_analysis_function_set_var (fcn, 0x30, RZ_ANAL_VAR_KIND_REG, "int64_t", 8, true, "arg42");
	mu_assert_notnull (c, "create a var");

	// querying variables

	RzAnalysisVar *v = rz_analysis_function_get_var (fcn, RZ_ANAL_VAR_KIND_REG, 0x41);
	mu_assert_null (v, "get no var");
	v = rz_analysis_function_get_var (fcn, RZ_ANAL_VAR_KIND_REG, 0x30);
	mu_assert_ptreq (v, c, "get var (reg)");
	v = rz_analysis_function_get_var (fcn, RZ_ANAL_VAR_KIND_SPV, -0x10);
	mu_assert_ptreq (v, b, "get var (sp)");
	v = rz_analysis_function_get_var (fcn, RZ_ANAL_VAR_KIND_BPV, -8);
	...
	rz_analysis_var_set_access (a, "rsp", 0x120, RZ_ANAL_VAR_ACCESS_TYPE_READ, 42);
	rz_analysis_var_set_access (a, "rbp", 0x130, RZ_ANAL_VAR_ACCESS_TYPE_WRITE, 13);
	rz_analysis_var_set_access (b, "rsp", 0x120, RZ_ANAL_VAR_ACCESS_TYPE_WRITE, 123);
	rz_analysis_var_set_access (b, "rbp", 0x10, RZ_ANAL_VAR_ACCESS_TYPE_WRITE, -100);
	...
	mu_assert ("no used vars", !used_vars || rz_pvector_len (used_vars));
	rz_analysis_var_set_access (a, "rbp", 0xffffffffffff0130UL, RZ_ANAL_VAR_ACCESS_TYPE_READ, 42);
	...
	mu_assert ("no used vars", !used_vars || rz_pvector_len (used_vars));
	rz_analysis_var_set_access (a, "rbp" , 0x123, RZ_ANAL_VAR_ACCESS_TYPE_READ, 42);
	used_vars = rz_analysis_function_get_vars_used_at (fcn, 0x123);
	mu_assert_eq (rz_pvector_len (used_vars), 1, "used vars count");
	mu_assert ("used vars", rz_pvector_contains (used_vars, a));
	...
	mu_assert ("no used vars", !used_vars || rz_pvector_len (used_vars));
	rz_analysis_var_set_access (a, "rbp", 0x8000000000000100, RZ_ANAL_VAR_ACCESS_TYPE_READ, 987321);
	used_vars = rz_analysis_function_get_vars_used_at (fcn, 0x8000000000000100);
	mu_assert_eq (rz_pvector_len (used_vars), 1, "used vars count");
	mu_assert ("used vars", rz_pvector_contains (used_vars, a));
	...
	mu_assert ("no used vars", !used_vars || rz_pvector_len (used_vars));
	rz_analysis_var_set_access (a, "rbp", 0x7ffffffffffffe00, RZ_ANAL_VAR_ACCESS_TYPE_READ, 777);
	used_vars = rz_analysis_function_get_vars_used_at (fcn, 0x7ffffffffffffe00);
	mu_assert_eq (rz_pvector_len (used_vars), 1, "used vars count");
	mu_assert ("used vars", rz_pvector_contains (used_vars, a));
