...
bool test_rz_core_addr_description_to_string(void) {
	...
	char *str = rz_core_addr_description_to_string(&desc, &opts);
	...
	str = rz_core_addr_description_to_string(&desc, &opts);
	mu_assert_notnull(str, "string should be allocated");
	...
	str = rz_core_addr_description_to_string(&desc2, &opts);
	mu_assert_notnull(str, "string should be allocated");
...
bool all_tests() {
	...
	mu_run_test(test_rz_core_addr_description_to_string);
