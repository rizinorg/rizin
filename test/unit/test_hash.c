...
#define INDATA(x) .input = (ut8 *)(x), .input_size = (sizeof(x) - 1)
	...
	{ INDATA(""), .algo = "ripemd160", .expected = "9c1185a5c5e9fc54612808977ee8f548b2258d31" },
	{ INDATA("abc"), .algo = "ripemd160", .expected = "8eb208f7e05d987a9b044a8e98c6b087f15a0bfc" },
	{ INDATA("Hello World"), .algo = "ripemd160", .expected = "a830d7beb04eb7549ce990fb7dc962e499a27230" },
