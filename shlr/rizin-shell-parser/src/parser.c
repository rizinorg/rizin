...
enum {
  ...
  sym__simple_arged_command_question = 171,
...
static uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym__simple_arged_command_question] = STATE(201),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [865] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__simple_arged_command_question, 2, .production_id = 4),
  [867] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__simple_arged_command_question, 2, .production_id = 4),
