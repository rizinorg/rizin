...
module.exports = grammar({
    ...
    rules: {
        ...
        iter_offsetssizes_command: $ => prec.right(1, seq($._simple_command, '@@@=', optional(alias($._offsetsizes_args, $.args)))),
        iter_hit_command: $ => prec.right(1, seq($._simple_command, '@@', $._concat, alias($._search_command, $.arged_command))),
        ...
        pointer_identifier: $ => '*',
        eq_sep_args: $ => seq(
            alias($._eq_sep_key, $.arg),
            optional(seq(
                '=',
                alias($._eq_sep_val, $.arg),
            )),
        ),
        macro_identifier: $ => /\([-\*]?/,
        ...
        _eq_sep_key_concatenation: $ => prec.left(seq(
            $._eq_sep_key_single,
            repeat1(seq(
                $._eq_sep_concat,
                $._eq_sep_key_single,
        ...
        _eq_sep_key: $ => choice(
            $._eq_sep_key_single,
            alias($._eq_sep_key_concatenation, $.concatenation),
        ),
        ...
        _eq_sep_val_concatenation: $ => prec.left(1, seq(
            $.arg,
            repeat1(seq(
                $._eq_sep_concat,
                $.arg,
        ...
        _eq_sep_val: $ => choice(
            $._arg,
            alias($._eq_sep_val_concatenation, $.concatenation),
        ),
        _any_command: $ => /[^\r\n;~|]+/,
