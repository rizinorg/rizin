...
$builddir=$(Join-Path -Path $PSScriptRoot -ChildPath "..\..\build-win-installer-$name-$bits")
$installdir=$(Join-Path -Path $PSScriptRoot -ChildPath "..\..\rizin-win-installer-$name-$bits")
