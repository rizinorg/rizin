  ...
  switch (state) {
    ...
    case 2:
	    ...
	    if (lookahead == '\t' ||
		    lookahead == ' ')
		    SKIP(2);
	    if ((!eof && set_contains(sym__eq_sep_key_identifier_character_set_1, 13, lookahead)))
		    ADVANCE(152);
	    END_STATE();
    case 3:
	    if (lookahead == '"')
    ...
    case 4:
	    ...
	    if (lookahead == '\t' ||
		    lookahead == ' ')
		    ADVANCE(59);
	    if ((!eof && set_contains(sym_grep_specifier_identifier_character_set_1, 10, lookahead)))
		    ADVANCE(61);
	    END_STATE();
    case 5:
	    if (lookahead == '#')
	    ...
	    if (lookahead == '\t' ||
		    lookahead == ' ')
		    SKIP(5);
	    if ((!eof && set_contains(aux_sym_spec_arg_identifier_token1_character_set_1, 12, lookahead)))
		    ADVANCE(160);
	    END_STATE();
    case 6:
	    if (lookahead == '#')
	    ...
	    if (lookahead == '\t' ||
		    lookahead == ' ')
		    SKIP(6);
	    if ((!eof && set_contains(aux_sym_tmp_eval_arg_token1_character_set_1, 13, lookahead)))
		    ADVANCE(146);
	    END_STATE();
    case 7:
	    if (lookahead == '#')
    ...
    case 9:
	    ...
	    if (lookahead == '{')
		    ADVANCE(43);
	    if ((!eof && set_contains(aux_sym_arg_identifier_token1_character_set_2, 12, lookahead)))
		    ADVANCE(154);
	    END_STATE();
    case 10:
	    if (lookahead == '$')
    ...
    case 41:
	    ...
	    END_STATE();
    case 42:
	    if ((!eof && set_contains(sym_grep_specifier_identifier_character_set_2, 9, lookahead)))
		    ADVANCE(61);
	    END_STATE();
    case 43:
	    if (lookahead != 0 &&
    ...
    case 153:
	    ...
	    if (lookahead == '\\')
		    ADVANCE(46);
	    if ((!eof && set_contains(aux_sym_arg_identifier_token1_character_set_1, 12, lookahead)))
		    ADVANCE(154);
	    END_STATE();
    case 154:
	    ACCEPT_TOKEN(aux_sym_arg_identifier_token1);
    ...
    case 156:
	    ...
	    if (lookahead == '{')
		    ADVANCE(155);
	    if ((!eof && set_contains(aux_sym_arg_identifier_token1_character_set_3, 11, lookahead)))
		    ADVANCE(154);
	    END_STATE();
    case 157:
	    ACCEPT_TOKEN(aux_sym_arg_identifier_token1);
...
static const TSParseActionEntry ts_parse_actions[] = {
	...
	REDUCE(sym_last_stmt_identifier, 1, 0, 0),
	...
	REDUCE(sym__alias_arged_stmt, 1, 0, 3),
	...
	REDUCE(sym_specifiers, 1, 0, 0),
	[410] = { .entry = { .count = 1, .reusable = false } },
	REDUCE(sym_specifiers, 1, 0, 0),
	[412] = { .entry = { .count = 1, .reusable = true } },
	REDUCE(aux_sym_concatenation_repeat1, 2, 0, 0),
	...
	REDUCE(sym_concatenation, 2, 0, 0),
	...
	REDUCE(sym_grep_specifier, 1, 0, 0),
	...
	REDUCE(aux_sym_tmp_eval_arg_repeat1, 2, 0, 0),
	...
	REDUCE(aux_sym__eq_sep_key_concatenation_repeat1, 2, 0, 0),
	...
	REDUCE(aux_sym_statements_repeat1, 2, 0, 0),
	...
	REDUCE(aux_sym__statements_singleline_repeat1, 2, 0, 0),
	SHIFT_REPEAT(226),
	...
	REDUCE(aux_sym_args_repeat1, 2, 0, 0),
	SHIFT_REPEAT(251),
	[923] = { .entry = { .count = 2, .reusable = false } },
	REDUCE(aux_sym_args_repeat1, 2, 0, 0),
	SHIFT_REPEAT(278),
	...
	REDUCE(sym_fdn_redirect_operator, 2, 0, 0),
	...
	REDUCE(sym_fdn_append_operator, 2, 0, 0),
	...
	REDUCE(aux_sym_double_quoted_arg_repeat1, 2, 0, 0),
	[1039] = { .entry = { .count = 2, .reusable = true } },
	REDUCE(aux_sym_double_quoted_arg_repeat1, 2, 0, 0),
	SHIFT_REPEAT(300),
	[1042] = { .entry = { .count = 2, .reusable = false } },
	REDUCE(aux_sym_double_quoted_arg_repeat1, 2, 0, 0),
	SHIFT_REPEAT(300),
	[1045] = { .entry = { .count = 2, .reusable = false } },
	REDUCE(aux_sym_double_quoted_arg_repeat1, 2, 0, 0),
	SHIFT_REPEAT(13),
	...
	REDUCE(aux_sym_single_quoted_arg_repeat1, 2, 0, 0),
	[1110] = { .entry = { .count = 2, .reusable = true } },
	REDUCE(aux_sym_single_quoted_arg_repeat1, 2, 0, 0),
	SHIFT_REPEAT(321),
	[1113] = { .entry = { .count = 2, .reusable = false } },
	REDUCE(aux_sym_single_quoted_arg_repeat1, 2, 0, 0),
	SHIFT_REPEAT(321),
	...
	REDUCE(sym__statements_singleline, 2, 0, 0),
	[1158] = { .entry = { .count = 1, .reusable = true } },
	REDUCE(sym__statements_singleline, 1, 0, 0),
	[1160] = { .entry = { .count = 1, .reusable = true } },
	SHIFT(22),
	[1162] = { .entry = { .count = 1, .reusable = true } },
	REDUCE(aux_sym__statements_singleline_repeat2, 2, 0, 0),
	[1164] = { .entry = { .count = 1, .reusable = true } },
	REDUCE(aux_sym_macro_body_repeat1, 2, 0, 0),
	[1166] = { .entry = { .count = 2, .reusable = true } },
	REDUCE(aux_sym_macro_body_repeat1, 2, 0, 0),
	SHIFT_REPEAT(30),
	...
	REDUCE(sym__statements_singleline, 3, 0, 0),
	[1177] = { .entry = { .count = 1, .reusable = true } },
	REDUCE(sym_macro_body, 2, 0, 0),
	[1179] = { .entry = { .count = 2, .reusable = true } },
	REDUCE(aux_sym__statements_singleline_repeat2, 2, 0, 0),
	SHIFT_REPEAT(25),
	...
	REDUCE(sym_macro_content, 3, 0, 19),
	...
	REDUCE(sym_macro_content, 2, 0, 17),
