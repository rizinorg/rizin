...
module.exports = grammar({
  ...
  rules: {
    ...
    tmp_seek_op: ($) => prec.right(1, seq("@ ", $.args)),
    tmp_blksz_op: ($) => prec.right(1, seq("@!", $.args)),
    tmp_fromto_op: ($) => prec.right(1, seq("@(", $.args, ")")),
    tmp_arch_op: ($) => prec.right(1, seq("@a:", $.arg)),
    tmp_bits_op: ($) => prec.right(1, seq("@b:", $.args)),
    tmp_nthi_op: ($) => prec.right(1, seq("@B:", $.arg)),
    tmp_eval_op: ($) => prec.right(1, seq("@e:", alias($.tmp_eval_args, $.args))),
    tmp_fs_op: ($) => prec.right(1, seq("@F:", $.arg)),
    tmp_reli_op: ($) => prec.right(1, seq("@i:", $.args)),
    tmp_kuery_op: ($) => prec.right(1, seq("@k:", $.arg)),
    tmp_fd_op: ($) => prec.right(1, seq("@o:", $.args)),
    tmp_reg_op: ($) => prec.right(1, seq("@r:", $.arg)),
    tmp_file_op: ($) => prec.right(1, seq("@f:", $.arg)),
    tmp_string_op: ($) => prec.right(1, seq("@s:", $.arg)),
    tmp_value_op: ($) => prec.right(1, seq("@v:", $.arg)),
    tmp_hex_op: ($) => prec.right(1, seq("@x:", $.arg)),
